...
PWRUP           JMP     PWRUP1                   ; F000: 7E F5 58       '~.X'
...
XINADD          JMP     XINADD1                  ; F00F: 7E FA 65       '~.e'
...
XPCRLF          JMP     XPCRLF1                  ; F021: 7E FA 41       '~.A'
XPDATA          JMP     XPDATA1                  ; F024: 7E FA 33       '~.3'
XPDAT           JMP     XPDAT1                   ; F027: 7E FA 35       '~.5'
...
ZF037           JSR     XCBCDH1                  ; F037: BD FA A7       '...'
                BMI     ZF0A8                    ; F03A: 2B 6C          '+l'
                ASL     $01,X                    ; F03C: 68 01          'h.'
                ROL     ,X                       ; F03E: 69 00          'i.'
...
ZF05B           CLR     MFF5A                    ; F05B: 7F FF 5A       '..Z'
ZF05E           INC     MFF5A                    ; F05E: 7C FF 5A       '|.Z'
...
ZF0DA           CMPA    #$30                     ; F0DA: 81 30          '.0'
                BMI     ZF0A8                    ; F0DC: 2B CA          '+.'
                CMPA    #$38                     ; F0DE: 81 38          '.8'
...
MAID            CLR     MFF60                    ; F0F3: 7F FF 60       '..`'
                CLR     MFF54                    ; F0F6: 7F FF 54       '..T'
ZF0F9           LDS     #XSTAK$                  ; F0F9: 8E FF 8A       '...'
                LDX     #MFBC2                   ; F0FC: CE FB C2       '...'
                JSR     XPDATA1                  ; F0FF: BD FA 33       '..3'
                JSR     ZFA62                    ; F102: BD FA 62       '..b'
                TSTB                             ; F105: 5D             ']'
                BNE     ZF130                    ; F106: 26 28          '&('
                CMPA    #$58                     ; F108: 81 58          '.X'
...
ZF13E           LDX     MFF08                    ; F13E: FE FF 08       '...'
                ...
                DEX                              ; F143: 09             '.'
ZF144           STX     MFF51                    ; F144: FF FF 51       '..Q'
                LDAA    #$FF                     ; F147: 86 FF          '..'
                STAA    MFF60                    ; F149: B7 FF 60       '..`'
                STAA    MFF50                    ; F14C: B7 FF 50       '..P'
                STAA    MFF54                    ; F14F: B7 FF 54       '..T'
                JMP     ZF431                    ; F152: 7E F4 31       '~.1'
...
ZF1AD           CMPA    #'N                      ; F1AD: 81 4E          '.N'
                BEQ     ZF13E                    ; F1AF: 27 8D          ''.'
                CMPA    #'P                      ; F1B1: 81 50          '.P'
                BNE     ZF1B8                    ; F1B3: 26 03          '&.'
                JMP     ZF3FC                    ; F1B5: 7E F3 FC       '~..'
ZF1B8           CMPA    #$55                     ; F1B8: 81 55          '.U'
                BEQ     ZF183                    ; F1BA: 27 C7          ''.'
                CMPA    #$56                     ; F1BC: 81 56          '.V'
                BEQ     ZF15A                    ; F1BE: 27 9A          ''.'
                CMPA    #$57                     ; F1C0: 81 57          '.W'
                BNE     ZF180                    ; F1C2: 26 BC          '&.'
                BRA     ZF23D                    ; F1C4: 20 77          ' w'
ZF1C6           INX                              ; F1C6: 08             '.'
                JSR     ZFA45                    ; F1C7: BD FA 45       '..E'
ZF1CA           STX     MFF56                    ; F1CA: FF FF 56       '..V'
ZF1CD           LDX     #MFF56                   ; F1CD: CE FF 56       '..V'
                JSR     ZFA2B                    ; F1D0: BD FA 2B       '..+'
                LDX     MFF56                    ; F1D3: FE FF 56       '..V'
ZF1D6           JSR     ZF971                    ; F1D6: BD F9 71       '..q'
                ...
                DEX                              ; F1E3: 09             '.'
                JSR     XPCRLF1                  ; F1E4: BD FA 41       '..A'
                BRA     ZF1CA                    ; F1E7: 20 E1          ' .'
ZF1E9           CMPA    #$3B                     ; F1E9: 81 3B          '.;'
                BNE     ZF180                    ; F1EB: 26 93          '&.'
                JSR     XINCHN1                  ; F1ED: BD FA A0       '...'
                CMPA    #$4F                     ; F1F0: 81 4F          '.O'
                BNE     ZF180                    ; F1F2: 26 8C          '&.'
                LDX     MFF56                    ; F1F4: FE FF 56       '..V'
                INX                              ; F1F7: 08             '.'
                STX     MFF5A                    ; F1F8: FF FF 5A       '..Z'
                LDAA    MFF5A                    ; F1FB: B6 FF 5A       '..Z'
...
ZF21C           JSR     XPCRLF1                  ; F21C: BD FA 41       '..A'
                BRA     ZF1CD                    ; F21F: 20 AC          ' .'
ZF221           LDX     #INVALID                 ; F221: CE FB 79       '..y'
                JSR     XPDAT1                   ; F224: BD FA 35       '..5'
                BRA     ZF21C                    ; F227: 20 F3          ' .'
ZF229           LDAA    MFF08                    ; F229: B6 FF 08       '...'
                LDAB    MFF09                    ; F22C: F6 FF 09       '...'
                SUBB    MFF5B                    ; F22F: F0 FF 5B       '..['
                SBCA    MFF5A                    ; F232: B2 FF 5A       '..Z'
...
ZF2D0           JSR     ZFAC0                    ; F2D0: BD FA C0       '...'
                JSR     ZF964                    ; F2D3: BD F9 64       '..d'
                INX                              ; F2D6: 08             '.'
                BRA     ZF2DF                    ; F2D7: 20 06          ' .'
ZF2D9           JSR     ZFAC0                    ; F2D9: BD FA C0       '...'
                JSR     ZF971                    ; F2DC: BD F9 71       '..q'
ZF2DF           CMPA    #$0D                     ; F2DF: 81 0D          '..'
                BEQ     ZF33A                    ; F2E1: 27 57          ''W'
                INX                              ; F2E3: 08             '.'
                CMPA    #$0A                     ; F2E4: 81 0A          '..'
                BEQ     ZF2EC                    ; F2E6: 27 04          ''.'
                JSR     XPCRLF1                  ; F2E8: BD FA 41       '..A'
                RTS                              ; F2EB: 39             '9'
ZF2EC           JSR     ZFA45                    ; F2EC: BD FA 45       '..E'
                RTS                              ; F2EF: 39             '9'
ZF2F0           JSR     ZFAC9                    ; F2F0: BD FA C9       '...'
                JSR     XPCRLF1                  ; F2F3: BD FA 41       '..A'
                LDX     #XREG$P                  ; F2F6: CE FF 16       '...'
                LDAA    #$50                     ; F2F9: 86 50          '.P'
                BSR     ZF2D0                    ; F2FB: 8D D3          '..'
                LDAA    #$58                     ; F2FD: 86 58          '.X'
                BSR     ZF2D0                    ; F2FF: 8D CF          '..'
                LDAA    #$41                     ; F301: 86 41          '.A'
                BSR     ZF2D9                    ; F303: 8D D4          '..'
                LDAA    #$42                     ; F305: 86 42          '.B'
                BSR     ZF2D9                    ; F307: 8D D0          '..'
                LDAA    #$43                     ; F309: 86 43          '.C'
                BSR     ZF2D9                    ; F30B: 8D CC          '..'
                LDAA    #$53                     ; F30D: 86 53          '.S'
                BSR     ZF2D0                    ; F30F: 8D BF          '..'
                BRA     ZF33A                    ; F311: 20 27          ' ''
ZF313           JSR     XPSPAC1                  ; F313: BD FA 26       '..&'
                LDX     #MFF12                   ; F316: CE FF 12       '...'
                JSR     ZF971                    ; F319: BD F9 71       '..q'
                BMI     ZF355                    ; F31C: 2B 37          '+7'
ZF31E           LDX     #BEGINADDR               ; F31E: CE FB 36       '..6'
                JSR     XPDATA1                  ; F321: BD FA 33       '..3'
                LDX     #MFF0E                   ; F324: CE FF 0E       '...'
                JSR     ZF964                    ; F327: BD F9 64       '..d'
                BMI     ZF31E                    ; F32A: 2B F2          '+.'
ZF32C           LDX     #ENDADDR                 ; F32C: CE FB 40       '..@'
                JSR     XPDATA1                  ; F32F: BD FA 33       '..3'
                LDX     #MFF10                   ; F332: CE FF 10       '...'
                JSR     ZF964                    ; F335: BD F9 64       '..d'
                BMI     ZF32C                    ; F338: 2B F2          '+.'
ZF33A           JMP     ZF0F9                    ; F33A: 7E F0 F9       '~..'
ZF33D           JSR     XINCHN1                  ; F33D: BD FA A0       '...'
                TAB                              ; F340: 16             '.'
                CMPB    #$52                     ; F341: C1 52          '.R'
                BEQ     ZF2F0                    ; F343: 27 AB          ''.'
                CMPB    #$56                     ; F345: C1 56          '.V'
                BEQ     ZF358                    ; F347: 27 0F          ''.'
                CMPB    #$4D                     ; F349: C1 4D          '.M'
                BEQ     ZF313                    ; F34B: 27 C6          ''.'
                CMPB    #$54                     ; F34D: C1 54          '.T'
                BEQ     ZF37D                    ; F34F: 27 2C          '','
                CMPB    #$53                     ; F351: C1 53          '.S'
                BEQ     ZF368                    ; F353: 27 13          ''.'
ZF355           JMP     ZF128                    ; F355: 7E F1 28       '~.('
ZF358           JSR     XPCRLF1                  ; F358: BD FA 41       '..A'
                LDX     #BRKPT$                  ; F35B: CE FF 1F       '...'
                LDAB    #$08                     ; F35E: C6 08          '..'
...
ZF3B7           LDX     MFF56                    ; F3B7: FE FF 56       '..V'
...
ZF3BC           INX                              ; F3BC: 08             '.'
                ...
                LDAA    #$FF                     ; F3C3: 86 FF          '..'
                STAA    BKPIN$                   ; F3C5: B7 FF 4F       '..O'
ZF3C8           RTS                              ; F3C8: 39             '9'
ZF3C9           TST     BKPIN$                   ; F3C9: 7D FF 4F       '}.O'
                BEQ     ZF3EC                    ; F3CC: 27 1E          ''.'
                LDX     #BRKPT$                  ; F3CE: CE FF 1F       '...'
ZF3D1           STX     MFF56                    ; F3D1: FF FF 56       '..V'
                LDAA    ,X                       ; F3D4: A6 00          '..'
...
ZF3DC           LDAA    $10,X                    ; F3DC: A6 10          '..'
                LDX     ,X                       ; F3DE: EE 00          '..'
                STAA    ,X                       ; F3E0: A7 00          '..'
ZF3E2           LDX     MFF56                    ; F3E2: FE FF 56       '..V'
                INX                              ; F3E5: 08             '.'
                INX                              ; F3E6: 08             '.'
                CPX     #MFF2F                   ; F3E7: 8C FF 2F       '../'
                BNE     ZF3D1                    ; F3EA: 26 E5          '&.'
ZF3EC           CLR     BKPIN$                   ; F3EC: 7F FF 4F       '..O'
                RTS                              ; F3EF: 39             '9'
ZF3F0           TST     MFF60                    ; F3F0: 7D FF 60       '}.`'
                BNE     ZF42C                    ; F3F3: 26 37          '&7'
                JSR     ZF2B4                    ; F3F5: BD F2 B4       '...'
                BEQ     ZF42C                    ; F3F8: 27 32          ''2'
...
ZF439           LDAA    ,X                       ; F439: A6 00          '..'
                ...
                LDAA    MFF5F                    ; F456: B6 FF 5F       '.._'
                STAA    PIA_0                    ; F459: B7 FC F8       '...'
                LDAA    MFF5E                    ; F45C: B6 FF 5E       '..^'
                STAA    PIA_2                    ; F45F: B7 FC FA       '...'
                LDAA    #$34                     ; F462: 86 34          '.4'
                STAA    PIA_1                    ; F464: B7 FC F9       '...'
ZF467           TST     MFF54                    ; F467: 7D FF 54       '}.T'
                BEQ     ZF476                    ; F46A: 27 0A          ''.'
                LDAA    #$34                     ; F46C: 86 34          '.4'
                STAA    PIA_3                    ; F46E: B7 FC FB       '...'
                LDAA    #$3C                     ; F471: 86 3C          '.<'
                STAA    PIA_3                    ; F473: B7 FC FB       '...'
ZF476           RTI                              ; F476: 3B             ';'
MF477           LDAB    #$07                     ; F477: C6 07          '..'
                LDX     #XREG$C                  ; F479: CE FF 1C       '...'
ZF47C           PULA                             ; F47C: 32             '2'
                STAA    ,X                       ; F47D: A7 00          '..'
                DEX                              ; F47F: 09             '.'
                DECB                             ; F480: 5A             'Z'
                BNE     ZF47C                    ; F481: 26 F9          '&.'
                STS     XREG$S                   ; F483: BF FF 1D       '...'
                LDS     #XSTAK$                  ; F486: 8E FF 8A       '...'
                BSR     ZF4BF                    ; F489: 8D 34          '.4'
                LDX     XREG$P                   ; F48B: FE FF 16       '...'
                DEX                              ; F48E: 09             '.'
                STX     XREG$P                   ; F48F: FF FF 16       '...'
                TST     BKPIN$                   ; F492: 7D FF 4F       '}.O'
                ...
                DES                              ; F4A3: 34             '4'
                STS     $20,X                    ; F4A4: AF 20          '. '
                LDS     #XSTAK$                  ; F4A6: 8E FF 8A       '...'
                BRA     ZF42C                    ; F4A9: 20 81          ' .'
ZF4AB           LDX     #BKPTERR                 ; F4AB: CE FB C4       '...'
                JSR     XPDATA1                  ; F4AE: BD FA 33       '..3'
                CLR     MFF60                    ; F4B1: 7F FF 60       '..`'
                CLR     MFF54                    ; F4B4: 7F FF 54       '..T'
ZF4B7           LDS     #XSTAK$                  ; F4B7: 8E FF 8A       '...'
                JSR     ZFAC9                    ; F4BA: BD FA C9       '...'
                BRA     ZF536                    ; F4BD: 20 77          ' w'
ZF4BF           LDX     #XREG$P                  ; F4BF: CE FF 16       '...'
                LDAA    ,X                       ; F4C2: A6 00          '..'
...
ZF567           STS     XREG$S                   ; F567: BF FF 1D       '...'
                ...
                DEX                              ; F585: 09             '.'
                LDX     ,X                       ; F586: EE 00          '..'
                STX     IRQ$VC                   ; F588: FF FF F8       '...'
                LDX     #BRKPT$                  ; F58B: CE FF 1F       '...'
ZF58E           CLR     ,X                       ; F58E: 6F 00          'o.'
                INX                              ; F590: 08             '.'
                CPX     #MFF63                   ; F591: 8C FF 63       '..c'
                BNE     ZF58E                    ; F594: 26 F8          '&.'
                LDS     #XSTAK$                  ; F596: 8E FF 8A       '...'
                LDAA    #$38                     ; F599: 86 38          '.8'
                STAA    PIA_1                    ; F59B: B7 FC F9       '...'
                LDAA    #$30                     ; F59E: 86 30          '.0'
                STAA    PIA_3                    ; F5A0: B7 FC FB       '...'
                LDAA    #$FF                     ; F5A3: 86 FF          '..'
                STAA    PIA_0                    ; F5A5: B7 FC F8       '...'
                STAA    PIA_2                    ; F5A8: B7 FC FA       '...'
                LDAA    #$34                     ; F5AB: 86 34          '.4'
...
ZF6C0           BSR     ZF6FA                    ; F6C0: 8D 38          '.8'
                ...
                LDAA    #$39                     ; F6F0: 86 39          '.9'
                JSR     XOUTCH1                  ; F6F2: BD F9 DC       '...'
ZF6F5           CLR     MFF62                    ; F6F5: 7F FF 62       '..b'
...
ZF70B           LDX     #EXEC                    ; F70B: CE FB 7F       '...'
                JSR     XPDATA1                  ; F70E: BD FA 33       '..3'
                JSR     ZFA4E                    ; F711: BD FA 4E       '..N'
                CMPA    #$59                     ; F714: 81 59          '.Y'
...
ZF736           JSR     XPCRLF1                  ; F736: BD FA 41       '..A'
ZF739           JSR     XPCRLF1                  ; F739: BD FA 41       '..A'
...
XBEGEN1         LDX     #BEGINADDR               ; F789: CE FB 36       '..6'
                JSR     XPDATA1                  ; F78C: BD FA 33       '..3'
                LDX     #MFF0A                   ; F78F: CE FF 0A       '...'
                JSR     ZF964                    ; F792: BD F9 64       '..d'
                BMI     XBEGEN1                  ; F795: 2B F2          '+.'
ZF797           LDX     #ENDADDR                 ; F797: CE FB 40       '..@'
                JSR     XPDATA1                  ; F79A: BD FA 33       '..3'
                LDX     #MFF0C                   ; F79D: CE FF 0C       '...'
                JSR     ZF964                    ; F7A0: BD F9 64       '..d'
...
SEARCH          LDAA    #$FF                     ; F7B4: 86 FF          '..'
                STAA    MFF5A                    ; F7B6: B7 FF 5A       '..Z'
                BRA     ZF7DF                    ; F7B9: 20 24          ' $'
LOAD            CLR     MFF5A                    ; F7BB: 7F FF 5A       '..Z'
                BRA     ZF7C8                    ; F7BE: 20 08          ' .'
VERIFY          LDAA    #$01                     ; F7C0: 86 01          '..'
                STAA    MFF5A                    ; F7C2: B7 FF 5A       '..Z'
                CLR     MFF61                    ; F7C5: 7F FF 61       '..a'
ZF7C8           LDX     #SGLCONT                 ; F7C8: CE FB 85       '...'
                JSR     XPDATA1                  ; F7CB: BD FA 33       '..3'
                JSR     ZFA4E                    ; F7CE: BD FA 4E       '..N'
                STAA    MFF58                    ; F7D1: B7 FF 58       '..X'
                CMPA    #$53                     ; F7D4: 81 53          '.S'
                BEQ     ZF7DF                    ; F7D6: 27 07          ''.'
                CMPA    #$43                     ; F7D8: 81 43          '.C'
                BNE     ZF7C8                    ; F7DA: 26 EC          '&.'
                JSR     XPCRLF1                  ; F7DC: BD FA 41       '..A'
ZF7DF           JSR     ROBJREC                  ; F7DF: BD F8 A4       '...'
                LDAA    MFF8C                    ; F7E2: B6 FF 8C       '...'
                CMPA    #$30                     ; F7E5: 81 30          '.0'
                BNE     ZF81C                    ; F7E7: 26 33          '&3'
...
ZF7EF           INX                              ; F7EF: 08             '.'
                ...
                JSR     XPDATA1                  ; F7FA: BD FA 33       '..3'
                JSR     ZF91D                    ; F7FD: BD F9 1D       '...'
                TST     MFF5A                    ; F800: 7D FF 5A       '}.Z'
                BPL     ZF7DF                    ; F803: 2A DA          '*.'
ZF805           LDX     #CONTLDVERF              ; F805: CE FB 4A       '..J'
                JSR     XPDATA1                  ; F808: BD FA 33       '..3'
                JSR     ZFA4E                    ; F80B: BD FA 4E       '..N'
                CMPA    #$43                     ; F80E: 81 43          '.C'
                BEQ     ZF7DF                    ; F810: 27 CD          ''.'
                CMPA    #$4C                     ; F812: 81 4C          '.L'
                BEQ     LOAD                     ; F814: 27 A5          ''.'
                CMPA    #$56                     ; F816: 81 56          '.V'
                BEQ     VERIFY                   ; F818: 27 A6          ''.'
                BRA     ZF805                    ; F81A: 20 E9          ' .'
ZF81C           TST     MFF5A                    ; F81C: 7D FF 5A       '}.Z'
                BMI     ZF7DF                    ; F81F: 2B BE          '+.'
                JSR     ZF91D                    ; F821: BD F9 1D       '...'
                LDAA    MFF8C                    ; F824: B6 FF 8C       '...'
                CMPA    #$31                     ; F827: 81 31          '.1'
                BEQ     ZF839                    ; F829: 27 0E          ''.'
                CMPA    #$39                     ; F82B: 81 39          '.9'
                BNE     ZF7DF                    ; F82D: 26 B0          '&.'
                LDAA    MFF58                    ; F82F: B6 FF 58       '..X'
                CMPA    #$43                     ; F832: 81 43          '.C'
...
ZF84A           STX     MFF56                    ; F84A: FF FF 56       '..V'
                LDX     MFF08                    ; F84D: FE FF 08       '...'
                LDAA    ,X                       ; F850: A6 00          '..'
                INX                              ; F852: 08             '.'
                STX     MFF08                    ; F853: FF FF 08       '...'
                LDX     MFF56                    ; F856: FE FF 56       '..V'
                TST     MFF5A                    ; F859: 7D FF 5A       '}.Z'
                BEQ     ZF895                    ; F85C: 27 37          ''7'
                CMPA    ,X                       ; F85E: A1 00          '..'
                BEQ     ZF88C                    ; F860: 27 2A          ''*'
                PSHA                             ; F862: 36             '6'
                STX     MFF56                    ; F863: FF FF 56       '..V'
                TST     MFF61                    ; F866: 7D FF 61       '}.a'
                BNE     ZF875                    ; F869: 26 0A          '&.'
                SEC                              ; F86B: 0D             '.'
                ROL     MFF61                    ; F86C: 79 FF 61       'y.a'
                LDX     #ADRMEMTAP               ; F86F: CE FB 6B       '..k'
                JSR     XPDATA1                  ; F872: BD FA 33       '..3'
ZF875           LDX     #MFF56                   ; F875: CE FF 56       '..V'
                JSR     XPCRLF1                  ; F878: BD FA 41       '..A'
                JSR     XOUT4H1                  ; F87B: BD FA 22       '.."'
                LDX     MFF56                    ; F87E: FE FF 56       '..V'
                JSR     XOUT2H1                  ; F881: BD FA 24       '..$'
                TSX                              ; F884: 30             '0'
                JSR     XOUT2H1                  ; F885: BD FA 24       '..$'
                PULA                             ; F888: 32             '2'
                LDX     MFF56                    ; F889: FE FF 56       '..V'
ZF88C           INX                              ; F88C: 08             '.'
                DEC     MFF8D                    ; F88D: 7A FF 8D       'z..'
                BNE     ZF84A                    ; F890: 26 B8          '&.'
                JMP     ZF7DF                    ; F892: 7E F7 DF       '~..'
ZF895           STAA    ,X                       ; F895: A7 00          '..'
                CMPA    ,X                       ; F897: A1 00          '..'
                BEQ     ZF88C                    ; F899: 27 F1          ''.'
                LDX     #NOCHNGE                 ; F89B: CE FB 5A       '..Z'
                JSR     XPDATA1                  ; F89E: BD FA 33       '..3'
...
ZF94B           BSR     ZF93F                    ; F94B: 8D F2          '..'
                ...
                INX                              ; F962: 08             '.'
ZF963           RTS                              ; F963: 39             '9'
ZF964           STX     MFF56                    ; F964: FF FF 56       '..V'
                LDAA    #$04                     ; F967: 86 04          '..'
                STAA    MFF5C                    ; F969: B7 FF 5C       '..\'
                JSR     XOUT4H1                  ; F96C: BD FA 22       '.."'
                BRA     ZF97C                    ; F96F: 20 0B          ' .'
ZF971           STX     MFF56                    ; F971: FF FF 56       '..V'
                LDAA    #$02                     ; F974: 86 02          '..'
                STAA    MFF5C                    ; F976: B7 FF 5C       '..\'
                JSR     XOUT2H1                  ; F979: BD FA 24       '..$'
ZF97C           JSR     ZFA62                    ; F97C: BD FA 62       '..b'
                LDX     MFF56                    ; F97F: FE FF 56       '..V'
                JSR     ZFA50                    ; F982: BD FA 50       '..P'
                BNE     ZF9BD                    ; F985: 26 36          '&6'
                TSTB                             ; F987: 5D             ']'
...
ZF9A4           LDX     #NOCHNGE                 ; F9A4: CE FB 5A       '..Z'
                JSR     XPDATA1                  ; F9A7: BD FA 33       '..3'
...
ZF9B7           CLRB                             ; F9B7: 5F             '_'
                LDX     MFF56                    ; F9B8: FE FF 56       '..V'
                TSTB                             ; F9BB: 5D             ']'
                RTS                              ; F9BC: 39             '9'
ZF9BD           LDAB    #$FF                     ; F9BD: C6 FF          '..'
                RTS                              ; F9BF: 39             '9'
XCHEXL1         LSRA                             ; F9C0: 44             'D'
                LSRA                             ; F9C1: 44             'D'
                LSRA                             ; F9C2: 44             'D'
                LSRA                             ; F9C3: 44             'D'
XCHEXR1         ANDA    #$0F                     ; F9C4: 84 0F          '..'
                ADDA    #$30                     ; F9C6: 8B 30          '.0'
                CMPA    #$39                     ; F9C8: 81 39          '.9'
                BLS     ZF9CE                    ; F9CA: 23 02          '#.'
                ADDA    #$07                     ; F9CC: 8B 07          '..'
ZF9CE           RTS                              ; F9CE: 39             '9'
OUTCNSF         PSHB                             ; F9CF: 37             '7'
...
ZFA45           LDAA    #$0D                     ; FA45: 86 0D          '..'
                ...
                RTS                              ; FA4D: 39             '9'
ZFA4E           BSR     XINCHN1                  ; FA4E: 8D 50          '.P'
ZFA50           CMPA    #$58                     ; FA50: 81 58          '.X'
...
XINADD1         CLR     MFF07                    ; FA65: 7F FF 07       '...'
                CLR     ,X                       ; FA68: 6F 00          'o.'
                CLR     $01,X                    ; FA6A: 6F 01          'o.'
ZFA6C           BSR     ZFAA5                    ; FA6C: 8D 37          '.7'
                BMI     ZFA87                    ; FA6E: 2B 17          '+.'
                LDAB    #$04                     ; FA70: C6 04          '..'
ZFA72           ASL     $01,X                    ; FA72: 68 01          'h.'
                ROL     ,X                       ; FA74: 69 00          'i.'
                DECB                             ; FA76: 5A             'Z'
...
ZFAC0           JSR     XOUTCH1                  ; FAC0: BD F9 DC       '...'
                ...
                RTS                              ; FAC8: 39             '9'
ZFAC9           JSR     XPCRLF1                  ; FAC9: BD FA 41       '..A'
ZFACC           LDX     #XREG$P                  ; FACC: CE FF 16       '...'
                LDAA    #$50                     ; FACF: 86 50          '.P'
                BSR     ZFAEE                    ; FAD1: 8D 1B          '..'
                LDAA    #$58                     ; FAD3: 86 58          '.X'
                BSR     ZFAEE                    ; FAD5: 8D 17          '..'
                LDAA    #$41                     ; FAD7: 86 41          '.A'
                BSR     S240                     ; FAD9: 8D 0D          '..'
                LDAA    #$42                     ; FADB: 86 42          '.B'
                BSR     S240                     ; FADD: 8D 09          '..'
                LDAA    #$43                     ; FADF: 86 43          '.C'
                BSR     S240                     ; FAE1: 8D 05          '..'
                LDAA    #$53                     ; FAE3: 86 53          '.S'
...
MFAF5           FCB     'L,'O,'A,'D              ; FAF5: 4C 4F 41 44    'LOAD'
                FDB     LOAD                     ; FAF9: F7 BB          '..'
                FCB     'V,'E,'R,'F              ; FAFB: 56 45 52 46    'VERF'
                FDB     VERIFY                   ; FAFF: F7 C0          '..'
                FCB     'S,'R,'C,'H              ; FB01: 53 52 43 48    'SRCH'
                FDB     SEARCH                   ; FB05: F7 B4          '..'
                FCB     'P,'R,'N,'T              ; FB07: 50 52 4E 54    'PRNT'
                FDB     PUNCH                    ; FB0B: F7 19          '..'
                FCB     'P,'N,'C,'H              ; FB0D: 50 4E 43 48    'PNCH'
                FDB     PUNCH                    ; FB11: F7 19          '..'
                FCB     'M,'A,'I,'D              ; FB13: 4D 41 49 44    'MAID'
                FDB     MAID                     ; FB17: F0 F3          '..'
                FCB     'S,'1,'0,'.              ; FB19: 53 31 30 2E    'S10.'
                FDB     S10                      ; FB1D: F6 23          '.#'
                FCB     'S,'3,'0,'.              ; FB1F: 53 33 30 2E    'S30.'
                FDB     S30                      ; FB23: F6 26          '.&'
                FCB     'S,'1,'2,'0              ; FB25: 53 31 32 30    'S120'
                FDB     S120                     ; FB29: F6 2D          '.-'
GREETING        FCB     'E,'X,'B,'U,'G,' ,'1,'.  ; FB2B: 45 58 42 55 47 20 31 2E 'EXBUG 1.'
                FCB     '1,'                     ; FB33: 31 20          '1 '
                FCB     $04                      ; FB35: 04             '.'
BEGINADDR       FCB     'B,'E,'G,' ,'A,'D,'D,'R  ; FB36: 42 45 47 20 41 44 44 52 'BEG ADDR'
                FCB     '                        ; FB3E: 20             ' '
                FCB     $04                      ; FB3F: 04             '.'
ENDADDR         FCB     'E,'N,'D,' ,'A,'D,'D,'R  ; FB40: 45 4E 44 20 41 44 44 52 'END ADDR'
                FCB     '                        ; FB48: 20             ' '
                FCB     $04                      ; FB49: 04             '.'
CONTLDVERF      FCB     'C,'O,'N,'T,'/,'L,'O,'A  ; FB4A: 43 4F 4E 54 2F 4C 4F 41 'CONT/LOA'
                FCB     'D,'/,'V,'E,'R,'F,'      ; FB52: 44 2F 56 45 52 46 20 'D/VERF '
                FCB     $04                      ; FB59: 04             '.'
NOCHNGE         FCB     'N,'O,' ,'C,'H,'A,'N,'G  ; FB5A: 4E 4F 20 43 48 41 4E 47 'NO CHANG'
                FCB     'E                       ; FB62: 45             'E'
                FCB     $07,$04                  ; FB63: 07 04          '..'
CHECKSM         FCB     'C,'K,'S,'M,'            ; FB65: 43 4B 53 4D 20 'CKSM '
                FCB     $04                      ; FB6A: 04             '.'
ADRMEMTAP       FCB     'A,'D,'D,'R,'/,'M,'E,'M  ; FB6B: 41 44 44 52 2F 4D 45 4D 'ADDR/MEM'
                FCB     '/,'T,'A,'P,'E           ; FB73: 2F 54 41 50 45 '/TAPE'
                FCB     $04                      ; FB78: 04             '.'
INVALID         FCB     ' ,'I,'N,'V,'L           ; FB79: 20 49 4E 56 4C ' INVL'
                FCB     $04                      ; FB7E: 04             '.'
EXEC            FCB     'E,'X,'E,'C,'            ; FB7F: 45 58 45 43 20 'EXEC '
                FCB     $04                      ; FB84: 04             '.'
SGLCONT         FCB     'S,'G,'L,'/,'C,'O,'N,'T  ; FB85: 53 47 4C 2F 43 4F 4E 54 'SGL/CONT'
                FCB     '                        ; FB8D: 20             ' '
                FCB     $04                      ; FB8E: 04             '.'
STOPONADDR      FCB     'S,'T,'O,'P,'-,'O,'N,'-  ; FB8F: 53 54 4F 50 2D 4F 4E 2D 'STOP-ON-'
                FCB     'A,'D,'D,'R,'E,'S,'S,'   ; FB97: 41 44 44 52 45 53 53 20 'ADDRESS '
                FCB     $04                      ; FB9F: 04             '.'
STOPADDR        FCB     'S,'T,'O,'P,' ,'A,'D,'D  ; FBA0: 53 54 4F 50 20 41 44 44 'STOP ADD'
                FCB     'R,'                     ; FBA8: 52 20          'R '
                FCB     $04                      ; FBAA: 04             '.'
ABORTED         FCB     'A,'B,'O,'R,'T,'E,'D,'   ; FBAB: 41 42 4F 52 54 45 44 20 'ABORTED '
                FCB     'A,'T,'                  ; FBB3: 41 54 20       'AT '
                FCB     $04                      ; FBB6: 04             '.'
...
MFBC2           FCB     '*                       ; FBC2: 2A             '*'
                FCB     $04                      ; FBC3: 04             '.'
BKPTERR         FCB     'B,'K,'P,'T,' ,'E,'R,'R  ; FBC4: 42 4B 50 54 20 45 52 52 'BKPT ERR'
                FCB     'O,'R,'                  ; FBCC: 4F 52 20       'OR '
                FCB     $04                      ; FBCF: 04             '.'
S1_TXT          FCB     $0d,$0a,$00              ; FBD0: 0D 0A 00       '...'
                FCB     'S,'1                    ; FBD3: 53 31          'S1'
                FCB     $04                      ; FBD5: 04             '.'
S9_TXT          FCB     $0d,$0a,$00              ; FBD6: 0D 0A 00       '...'
                FCB     'S,'9,'0,'3,'0,'0,'0,'0  ; FBD9: 53 39 30 33 30 30 30 30 'S9030000'
                FCB     'F,'C                    ; FBE1: 46 43          'FC'
                FCB     $0d,$04                  ; FBE3: 0D 04          '..'
S0_TXT          FCB     $0d,$0a,$00              ; FBE5: 0D 0A 00       '...'
                FCB     'S,'0,'0,'B,'0,'0,'0,'0  ; FBE8: 53 30 30 42 30 30 30 30 'S00B0000'
                FCB     '5,'8,'2,'0              ; FBF0: 35 38 32 30    '5820'
                FCB     $04                      ; FBF4: 04             '.'
HD_TXT          FCB     'H,'D,'R,'=,'X,'         ; FBF5: 48 44 52 3D 58 20 'HDR=X '
