...
PWRUP           JMP     PWRUP1                   ; F000: 7E F5 47       '~.G'
...
XINADD          JMP     XINADD1                  ; F00F: 7E FA 43       '~.C'
XINCH           JMP     XINCH1                   ; F012: 7E FA 6B       '~.k'
...
ZF059           CLR     MFF5A                    ; F059: 7F FF 5A       '..Z'
ZF05C           INC     MFF5A                    ; F05C: 7C FF 5A       '|.Z'
                ...
                ADCA    ,X                       ; F067: A9 00          '..'
                PSHA                             ; F069: 36             '6'
                LDAA    MFF5A                    ; F06A: B6 FF 5A       '..Z'
                ADDA    #$2F                     ; F06D: 8B 2F          './'
                JSR     XOUTCH1                  ; F06F: BD F9 E2       '...'
                PULA                             ; F072: 32             '2'
                INX                              ; F073: 08             '.'
                INX                              ; F074: 08             '.'
                CPX     #ZF037                   ; F075: 8C F0 37       '..7'
                BNE     ZF059                    ; F078: 26 DF          '&.'
                BRA     MAID$                    ; F07A: 20 77          ' w'
ZF07C           ASL     $01,X                    ; F07C: 68 01          'h.'
                ROL     ,X                       ; F07E: 69 00          'i.'
                ASL     $01,X                    ; F080: 68 01          'h.'
                ROL     ,X                       ; F082: 69 00          'i.'
                ASL     $01,X                    ; F084: 68 01          'h.'
                ROL     ,X                       ; F086: 69 00          'i.'
                RTS                              ; F088: 39             '9'
ZF089           LDX     #MFF08                   ; F089: CE FF 08       '...'
                CLR     MFF07                    ; F08C: 7F FF 07       '...'
                CLR     ,X                       ; F08F: 6F 00          'o.'
                CLR     $01,X                    ; F091: 6F 01          'o.'
                JSR     XINCHN1                  ; F093: BD FA 7F       '...'
                CMPA    #'$                      ; F096: 81 24          '.$'
                BEQ     ZF046                    ; F098: 27 AC          ''.'
                CMPA    #'@                      ; F09A: 81 40          '.@'
                BEQ     ZF0E4                    ; F09C: 27 46          ''F'
ZF09E           CMPA    #'0                      ; F09E: 81 30          '.0'
                BMI     ZF0A6                    ; F0A0: 2B 04          '+.'
                CMPA    #'9                      ; F0A2: 81 39          '.9'
                BLE     ZF0A8                    ; F0A4: 2F 02          '/.'
ZF0A6           BRA     ZF11E                    ; F0A6: 20 76          ' v'
...
MAID            CLR     MFF60                    ; F0ED: 7F FF 60       '..`'
                CLR     MFF54                    ; F0F0: 7F FF 54       '..T'
MAID$           LDS     #XSTAK$                  ; F0F3: 8E FF 8A       '...'
...
ZF10C           CMPA    #';                      ; F10C: 81 3B          '.;'
                ...
                JMP     ZF274                    ; F110: 7E F2 74       '~.t'
ZF113           CMPA    #'N                      ; F113: 81 4E          '.N'
                BEQ     ZF14B                    ; F115: 27 34          ''4'
                CMPA    #'#                      ; F117: 81 23          '.#'
                BNE     ZF11E                    ; F119: 26 03          '&.'
                JMP     ZF089                    ; F11B: 7E F0 89       '~..'
ZF11E           LDX     #MFBC2                   ; F11E: CE FB C2       '...'
                JSR     XPDAT1                   ; F121: BD FA 16       '...'
ZF124           BRA     MAID$                    ; F124: 20 CD          ' .'
ZF126           CMPA    #';                      ; F126: 81 3B          '.;'
                BEQ     ZF198                    ; F128: 27 6E          ''n'
...
ZF134           LDX     MFF08                    ; F134: FE FF 08       '...'
                ...
                DEX                              ; F139: 09             '.'
ZF13A           STX     MFF51                    ; F13A: FF FF 51       '..Q'
                LDAA    #$FF                     ; F13D: 86 FF          '..'
                STAA    MFF60                    ; F13F: B7 FF 60       '..`'
                STAA    MFF50                    ; F142: B7 FF 50       '..P'
                STAA    MFF54                    ; F145: B7 FF 54       '..T'
...
ZF1A2           CMPA    #'N                      ; F1A2: 81 4E          '.N'
                BEQ     ZF134                    ; F1A4: 27 8E          ''.'
                CMPA    #'P                      ; F1A6: 81 50          '.P'
                BNE     ZF1AD                    ; F1A8: 26 03          '&.'
                JMP     ZF3D1                    ; F1AA: 7E F3 D1       '~..'
ZF1AD           CMPA    #'U                      ; F1AD: 81 55          '.U'
                BEQ     ZF178                    ; F1AF: 27 C7          ''.'
                CMPA    #'V                      ; F1B1: 81 56          '.V'
                BEQ     ZF150                    ; F1B3: 27 9B          ''.'
                CMPA    #'W                      ; F1B5: 81 57          '.W'
                BNE     ZF176                    ; F1B7: 26 BD          '&.'
                BRA     ZF232                    ; F1B9: 20 77          ' w'
ZF1BB           INX                              ; F1BB: 08             '.'
                JSR     ZFA25                    ; F1BC: BD FA 25       '..%'
ZF1BF           STX     MFF56                    ; F1BF: FF FF 56       '..V'
ZF1C2           LDX     #MFF56                   ; F1C2: CE FF 56       '..V'
                JSR     ZF9DC                    ; F1C5: BD F9 DC       '...'
                LDX     MFF56                    ; F1C8: FE FF 56       '..V'
ZF1CB           JSR     ZF96A                    ; F1CB: BD F9 6A       '..j'
...
ZF1DE           CMPA    #';                      ; F1DE: 81 3B          '.;'
                ...
                LDX     MFF56                    ; F1E9: FE FF 56       '..V'
                INX                              ; F1EC: 08             '.'
                STX     MFF5A                    ; F1ED: FF FF 5A       '..Z'
                LDAA    MFF5A                    ; F1F0: B6 FF 5A       '..Z'
...
ZF29B           LDX     #BRKPT$                  ; F29B: CE FF 1F       '...'
ZF29E           CLR     ,X                       ; F29E: 6F 00          'o.'
                INX                              ; F2A0: 08             '.'
                CPX     #BKPIN$                  ; F2A1: 8C FF 4F       '..O'
                BNE     ZF29E                    ; F2A4: 26 F8          '&.'
ZF2A6           JMP     MAID$                    ; F2A6: 7E F0 F3       '~..'
ZF2A9           LDAA    XREG$P                   ; F2A9: B6 FF 16       '...'
                LDAB    MFF17                    ; F2AC: F6 FF 17       '...'
ZF2AF           LDX     #BRKPT$                  ; F2AF: CE FF 1F       '...'
...
ZF2C5           JSR     ZFA9F                    ; F2C5: BD FA 9F       '...'
                JSR     ZF961                    ; F2C8: BD F9 61       '..a'
                INX                              ; F2CB: 08             '.'
                BRA     ZF2D4                    ; F2CC: 20 06          ' .'
ZF2CE           JSR     ZFA9F                    ; F2CE: BD FA 9F       '...'
                JSR     ZF96A                    ; F2D1: BD F9 6A       '..j'
...
ZF38E           LDX     MFF56                    ; F38E: FE FF 56       '..V'
...
ZF393           INX                              ; F393: 08             '.'
                ...
                LDAA    #$FF                     ; F39A: 86 FF          '..'
                STAA    BKPIN$                   ; F39C: B7 FF 4F       '..O'
ZF39F           RTS                              ; F39F: 39             '9'
ZF3A0           TST     BKPIN$                   ; F3A0: 7D FF 4F       '}.O'
                BEQ     ZF3C1                    ; F3A3: 27 1C          ''.'
                LDX     #BRKPT$                  ; F3A5: CE FF 1F       '...'
ZF3A8           STX     MFF56                    ; F3A8: FF FF 56       '..V'
                LDAA    ,X                       ; F3AB: A6 00          '..'
...
ZF3C1           CLR     BKPIN$                   ; F3C1: 7F FF 4F       '..O'
                RTS                              ; F3C4: 39             '9'
ZF3C5           TST     MFF60                    ; F3C5: 7D FF 60       '}.`'
                BNE     ZF401                    ; F3C8: 26 37          '&7'
                JSR     ZF2A9                    ; F3CA: BD F2 A9       '...'
                BEQ     ZF401                    ; F3CD: 27 32          ''2'
...
ZF3DE           LDS     MFF08                    ; F3DE: BE FF 08       '...'
                DES                              ; F3E1: 34             '4'
                STS     $20,X                    ; F3E2: AF 20          '. '
                LDS     #XSTAK$                  ; F3E4: 8E FF 8A       '...'
                BRA     ZF401                    ; F3E7: 20 18          ' .'
ZF3E9           LDX     RAM_START                ; F3E9: FE FF 00       '...'
                DEX                              ; F3EC: 09             '.'
                LDX     ,X                       ; F3ED: EE 00          '..'
                BRA     ZF3F4                    ; F3EF: 20 03          ' .'
ZF3F1           LDX     MFF08                    ; F3F1: FE FF 08       '...'
ZF3F4           STX     XREG$P                   ; F3F4: FF FF 16       '...'
                TST     MFF60                    ; F3F7: 7D FF 60       '}.`'
                BMI     ZF401                    ; F3FA: 2B 05          '+.'
ZF3FC           JSR     ZF36E                    ; F3FC: BD F3 6E       '..n'
                BRA     ZF406                    ; F3FF: 20 05          ' .'
ZF401           LDAA    #$FF                     ; F401: 86 FF          '..'
                STAA    MFF54                    ; F403: B7 FF 54       '..T'
ZF406           LDAB    #$05                     ; F406: C6 05          '..'
                LDS     XREG$S                   ; F408: BE FF 1D       '...'
                LDX     #XREG$P                  ; F40B: CE FF 16       '...'
...
MF448           LDAA    #$3C                     ; F448: 86 3C          '.<'
                ...
                LDAB    #$07                     ; F44D: C6 07          '..'
                LDX     #XREG$C                  ; F44F: CE FF 1C       '...'
ZF452           PULA                             ; F452: 32             '2'
                STAA    ,X                       ; F453: A7 00          '..'
                DEX                              ; F455: 09             '.'
                DECB                             ; F456: 5A             'Z'
                BNE     ZF452                    ; F457: 26 F9          '&.'
                STS     XREG$S                   ; F459: BF FF 1D       '...'
                LDS     #XSTAK$                  ; F45C: 8E FF 8A       '...'
                BSR     ZF496                    ; F45F: 8D 35          '.5'
                LDX     XREG$P                   ; F461: FE FF 16       '...'
                DEX                              ; F464: 09             '.'
                STX     XREG$P                   ; F465: FF FF 16       '...'
                TST     BKPIN$                   ; F468: 7D FF 4F       '}.O'
                ...
                DES                              ; F479: 34             '4'
                STS     $20,X                    ; F47A: AF 20          '. '
                LDS     #XSTAK$                  ; F47C: 8E FF 8A       '...'
                BRA     ZF401                    ; F47F: 20 80          ' .'
ZF481           LDX     #BKPTERR                 ; F481: CE FB C8       '...'
                JSR     XPDATA1                  ; F484: BD FA 14       '...'
                CLR     MFF60                    ; F487: 7F FF 60       '..`'
                CLR     MFF54                    ; F48A: 7F FF 54       '..T'
ZF48D           LDS     #XSTAK$                  ; F48D: 8E FF 8A       '...'
                JSR     ZFAA5                    ; F490: BD FA A5       '...'
                JMP     MAID$                    ; F493: 7E F0 F3       '~..'
ZF496           LDX     #XREG$P                  ; F496: CE FF 16       '...'
                LDAA    ,X                       ; F499: A6 00          '..'
...
ZF4C2           LDAA    $06,X                    ; F4C2: A6 06          '..'
                ...
                INS                              ; F4CB: 31             '1'
                PSHA                             ; F4CC: 36             '6'
                LDAA    IRQ$VC                   ; F4CD: B6 FF F8       '...'
                STAA    $05,X                    ; F4D0: A7 05          '..'
                LDAA    MFFF9                    ; F4D2: B6 FF F9       '...'
                STAA    $06,X                    ; F4D5: A7 06          '..'
ZF4D7           LDAB    #$07                     ; F4D7: C6 07          '..'
                LDX     #XREG$C                  ; F4D9: CE FF 1C       '...'
ZF4DC           PULA                             ; F4DC: 32             '2'
                STAA    ,X                       ; F4DD: A7 00          '..'
                DEX                              ; F4DF: 09             '.'
                DECB                             ; F4E0: 5A             'Z'
                BNE     ZF4DC                    ; F4E1: 26 F9          '&.'
                STS     XREG$S                   ; F4E3: BF FF 1D       '...'
                LDS     #XSTAK$                  ; F4E6: 8E FF 8A       '...'
                ...
                TST     MFF50                    ; F50B: 7D FF 50       '}.P'
                BEQ     ZF51C                    ; F50E: 27 0C          ''.'
                LDX     MFF51                    ; F510: FE FF 51       '..Q'
                BEQ     ZF524                    ; F513: 27 0F          ''.'
                DEX                              ; F515: 09             '.'
                STX     MFF51                    ; F516: FF FF 51       '..Q'
ZF519           JMP     ZF406                    ; F519: 7E F4 06       '~..'
ZF51C           LDX     XREG$P                   ; F51C: FE FF 16       '...'
                CPX     MFF14                    ; F51F: BC FF 14       '...'
                BNE     ZF519                    ; F522: 26 F5          '&.'
ZF524           CLR     MFF50                    ; F524: 7F FF 50       '..P'
                JMP     ZF267                    ; F527: 7E F2 67       '~.g'
ZF52A           LDX     #STOPONADDR              ; F52A: CE FB 93       '...'
                JSR     XPDATA1                  ; F52D: BD FA 14       '...'
                JSR     ZFAA8                    ; F530: BD FA A8       '...'
                JMP     MAID$                    ; F533: 7E F0 F3       '~..'
ZF536           CLR     MFF54                    ; F536: 7F FF 54       '..T'
...
PWRUP1          NOP                              ; F547: 01             '.'
                ...
                STX     RAM_START                ; F561: FF FF 00       '...'
                LDS     #XSTAK$                  ; F564: 8E FF 8A       '...'
                STS     XREG$S                   ; F567: BF FF 1D       '...'
ZF56A           LDX     #MF4AA                   ; F56A: CE F4 AA       '...'
                STX     NMI$VC                   ; F56D: FF FF FC       '...'
                LDX     #MF448                   ; F570: CE F4 48       '..H'
                STX     SWI$VC                   ; F573: FF FF FA       '...'
                LDX     RAM_START                ; F576: FE FF 00       '...'
                LDAA    #$07                     ; F579: 86 07          '..'
ZF57B           DEX                              ; F57B: 09             '.'
                DECA                             ; F57C: 4A             'J'
                BNE     ZF57B                    ; F57D: 26 FC          '&.'
                LDX     ,X                       ; F57F: EE 00          '..'
                STX     IRQ$VC                   ; F581: FF FF F8       '...'
                LDX     #BRKPT$                  ; F584: CE FF 1F       '...'
ZF587           CLR     ,X                       ; F587: 6F 00          'o.'
                INX                              ; F589: 08             '.'
                CPX     #MFF63                   ; F58A: 8C FF 63       '..c'
                BNE     ZF587                    ; F58D: 26 F8          '&.'
                LDX     #PIA_0                   ; F58F: CE FC F8       '...'
                LDAA    #$38                     ; F592: 86 38          '.8'
                STAA    $01,X                    ; F594: A7 01          '..'
                LDAA    #$30                     ; F596: 86 30          '.0'
                STAA    $03,X                    ; F598: A7 03          '..'
                LDAA    #$FF                     ; F59A: 86 FF          '..'
                STAA    ,X                       ; F59C: A7 00          '..'
                STAA    $02,X                    ; F59E: A7 02          '..'
                LDAA    #$34                     ; F5A0: 86 34          '.4'
                ...
                BSR     ZF622                    ; F5B0: 8D 70          '.p'
                LDAA    #$3A                     ; F5B2: 86 3A          '.:'
                BSR     ZF624                    ; F5B4: 8D 6E          '.n'
                BSR     ZF622                    ; F5B6: 8D 6A          '.j'
                LDAA    #$39                     ; F5B8: 86 39          '.9'
                BSR     ZF624                    ; F5BA: 8D 68          '.h'
                LDX     #MFBBB                   ; F5BC: CE FB BB       '...'
                JSR     XPDAT1                   ; F5BF: BD FA 16       '...'
REENT3          LDS     #XSTAK$                  ; F5C2: 8E FF 8A       '...'
                BSR     ZF61B                    ; F5C5: 8D 54          '.T'
...
ZF614           INX                              ; F614: 08             '.'
                ...
                INX                              ; F619: 08             '.'
                RTS                              ; F61A: 39             '9'
ZF61B           LDX     #M30D4                   ; F61B: CE 30 D4       '.0.'
ZF61E           DEX                              ; F61E: 09             '.'
...
ZF6C2           BSR     ZF6FD                    ; F6C2: 8D 39          '.9'
                ...
                LDAA    #$39                     ; F6F3: 86 39          '.9'
                JSR     XOUTCH1                  ; F6F5: BD F9 E2       '...'
ZF6F8           CLR     MFF62                    ; F6F8: 7F FF 62       '..b'
                BRA     PUNCH                    ; F6FB: 20 1D          ' .'
ZF6FD           ADDB    ,X                       ; F6FD: EB 00          '..'
                JMP     ZFA07                    ; F6FF: 7E FA 07       '~..'
ZF702           LDAB    #$37                     ; F702: C6 37          '.7'
ZF704           CLRA                             ; F704: 4F             'O'
...
ZF70C           LDX     #EXEC                    ; F70C: CE FB 83       '...'
                ...
                RTS                              ; F719: 39             '9'
PUNCH           BSR     XBEGEN1                  ; F71A: 8D 6B          '.k'
                LDAA    MFF04                    ; F71C: B6 FF 04       '...'
                CMPA    #'R                      ; F71F: 81 52          '.R'
                BEQ     ZF726                    ; F721: 27 03          ''.'
                JMP     ZF634                    ; F723: 7E F6 34       '~.4'
...
XBEGEN1         LDX     #BEGINADDR               ; F787: CE FB 3A       '..:'
                ...
                JSR     ZF961                    ; F790: BD F9 61       '..a'
                BMI     XBEGEN1                  ; F793: 2B F2          '+.'
ZF795           LDX     #ENDADDR                 ; F795: CE FB 44       '..D'
                JSR     XPDATA1                  ; F798: BD FA 14       '...'
                LDX     #MFF0C                   ; F79B: CE FF 0C       '...'
                JSR     ZF961                    ; F79E: BD F9 61       '..a'
...
SEARCH          LDAA    #$FF                     ; F7B2: 86 FF          '..'
                STAA    MFF5A                    ; F7B4: B7 FF 5A       '..Z'
                BRA     ZF7DD                    ; F7B7: 20 24          ' $'
LOAD            CLR     MFF5A                    ; F7B9: 7F FF 5A       '..Z'
                BRA     ZF7C6                    ; F7BC: 20 08          ' .'
VERIFY          LDAA    #$01                     ; F7BE: 86 01          '..'
                STAA    MFF5A                    ; F7C0: B7 FF 5A       '..Z'
...
ZF81A           TST     MFF5A                    ; F81A: 7D FF 5A       '}.Z'
                ...
                LDAA    MFF58                    ; F82D: B6 FF 58       '..X'
                CMPA    #'C                      ; F830: 81 43          '.C'
                BEQ     ZF7DD                    ; F832: 27 A9          ''.'
                BRA     ZF89E                    ; F834: 20 68          ' h'
...
ZF847           STX     MFF56                    ; F847: FF FF 56       '..V'
                LDX     MFF08                    ; F84A: FE FF 08       '...'
                LDAA    ,X                       ; F84D: A6 00          '..'
                INX                              ; F84F: 08             '.'
                STX     MFF08                    ; F850: FF FF 08       '...'
                LDX     MFF56                    ; F853: FE FF 56       '..V'
                TST     MFF5A                    ; F856: 7D FF 5A       '}.Z'
                BEQ     ZF892                    ; F859: 27 37          ''7'
                CMPA    ,X                       ; F85B: A1 00          '..'
                BEQ     ZF889                    ; F85D: 27 2A          ''*'
                PSHA                             ; F85F: 36             '6'
                STX     MFF56                    ; F860: FF FF 56       '..V'
                TST     MFF61                    ; F863: 7D FF 61       '}.a'
                BNE     ZF872                    ; F866: 26 0A          '&.'
                SEC                              ; F868: 0D             '.'
                ROL     MFF61                    ; F869: 79 FF 61       'y.a'
                LDX     #ADRMEMTAP               ; F86C: CE FB 6F       '..o'
                JSR     XPDATA1                  ; F86F: BD FA 14       '...'
ZF872           LDX     #MFF56                   ; F872: CE FF 56       '..V'
                JSR     XPCRLF1                  ; F875: BD FA 21       '..!'
                JSR     XOUT4H1                  ; F878: BD F9 C7       '...'
                LDX     MFF56                    ; F87B: FE FF 56       '..V'
                JSR     XOUT2H1                  ; F87E: BD F9 C9       '...'
                TSX                              ; F881: 30             '0'
                JSR     XOUT2H1                  ; F882: BD F9 C9       '...'
                PULA                             ; F885: 32             '2'
                LDX     MFF56                    ; F886: FE FF 56       '..V'
ZF889           INX                              ; F889: 08             '.'
                DEC     MFF8D                    ; F88A: 7A FF 8D       'z..'
...
ZF8EE           STAA    MFF8C                    ; F8EE: B7 FF 8C       '...'
                ...
                BSR     ZF948                    ; F8F4: 8D 52          '.R'
                STAA    MFF07                    ; F8F6: B7 FF 07       '...'
ZF8F9           BSR     ZF948                    ; F8F9: 8D 4D          '.M'
                DEC     MFF07                    ; F8FB: 7A FF 07       'z..'
...
ZF91D           LDX     #CHECKSM                 ; F91D: CE FB 69       '..i'
...
ZF935           CMPA    #$43                     ; F935: 81 43          '.C'
                BNE     ZF91D                    ; F937: 26 E4          '&.'
                LDAA    #$FF                     ; F939: 86 FF          '..'
ZF93B           RTS                              ; F93B: 39             '9'
ZF93C           SEC                              ; F93C: 0D             '.'
                ROL     AECHO                    ; F93D: 79 FF 53       'y.S'
...
ZF948           BSR     ZF93C                    ; F948: 8D F2          '..'
                ...
                INX                              ; F95F: 08             '.'
ZF960           RTS                              ; F960: 39             '9'
ZF961           STX     MFF56                    ; F961: FF FF 56       '..V'
                BSR     XOUT4H1                  ; F964: 8D 61          '.a'
                LDAA    #$04                     ; F966: 86 04          '..'
                BRA     ZF971                    ; F968: 20 07          ' .'
ZF96A           STX     MFF56                    ; F96A: FF FF 56       '..V'
                BSR     XOUT2H1                  ; F96D: 8D 5A          '.Z'
                LDAA    #$02                     ; F96F: 86 02          '..'
ZF971           STAA    MFF5C                    ; F971: B7 FF 5C       '..\'
                JSR     ZFA40                    ; F974: BD FA 40       '..@'
                LDX     MFF56                    ; F977: FE FF 56       '..V'
                JSR     ZFA2E                    ; F97A: BD FA 2E       '...'
                BNE     ZF9B5                    ; F97D: 26 36          '&6'
                TSTB                             ; F97F: 5D             ']'
...
ZF99C           LDX     #NOCHNGE                 ; F99C: CE FB 5E       '..^'
                ...
                JMP     MAID$                    ; F9A2: 7E F0 F3       '~..'
ZF9A5           INX                              ; F9A5: 08             '.'
ZF9A6           LDAB    MFF09                    ; F9A6: F6 FF 09       '...'
                STAB    ,X                       ; F9A9: E7 00          '..'
                CMPB    ,X                       ; F9AB: E1 00          '..'
                BNE     ZF99C                    ; F9AD: 26 ED          '&.'
ZF9AF           CLRB                             ; F9AF: 5F             '_'
                LDX     MFF56                    ; F9B0: FE FF 56       '..V'
                TSTB                             ; F9B3: 5D             ']'
                RTS                              ; F9B4: 39             '9'
ZF9B5           LDAB    #$FF                     ; F9B5: C6 FF          '..'
                RTS                              ; F9B7: 39             '9'
XCHEXL1         LSRA                             ; F9B8: 44             'D'
                LSRA                             ; F9B9: 44             'D'
                LSRA                             ; F9BA: 44             'D'
                LSRA                             ; F9BB: 44             'D'
XCHEXR1         ANDA    #$0F                     ; F9BC: 84 0F          '..'
                ADDA    #$30                     ; F9BE: 8B 30          '.0'
                CMPA    #$39                     ; F9C0: 81 39          '.9'
...
ZF9FD           LDAB    MFFF6                    ; F9FD: F6 FF F6       '...'
                TST     MFF62                    ; FA00: 7D FF 62       '}.b'
                BEQ     ZF9F3                    ; FA03: 27 EE          ''.'
ZFA05           PULB                             ; FA05: 33             '3'
                RTS                              ; FA06: 39             '9'
...
ZFA2C           BSR     XINCHN1                  ; FA2C: 8D 51          '.Q'
ZFA2E           CMPA    #$58                     ; FA2E: 81 58          '.X'
...
XINADD1         CLR     MFF07                    ; FA43: 7F FF 07       '...'
                CLR     ,X                       ; FA46: 6F 00          'o.'
                CLR     $01,X                    ; FA48: 6F 01          'o.'
ZFA4A           BSR     ZFA84                    ; FA4A: 8D 38          '.8'
                BMI     ZFA67                    ; FA4C: 2B 19          '+.'
                LDAB    #$04                     ; FA4E: C6 04          '..'
ZFA50           ASL     $01,X                    ; FA50: 68 01          'h.'
                ROL     ,X                       ; FA52: 69 00          'i.'
                DECB                             ; FA54: 5A             'Z'
...
ZFAA8           LDX     #XREG$P                  ; FAA8: CE FF 16       '...'
                LDAA    #'P                      ; FAAB: 86 50          '.P'
...
MFAED           FCB     'L,'O,'A,'D              ; FAED: 4C 4F 41 44    'LOAD'
                FDB     LOAD                     ; FAF1: F7 B9          '..'
                FCB     'V,'E,'R,'F              ; FAF3: 56 45 52 46    'VERF'
                FDB     VERIFY                   ; FAF7: F7 BE          '..'
                FCB     'S,'R,'C,'H              ; FAF9: 53 52 43 48    'SRCH'
                FDB     SEARCH                   ; FAFD: F7 B2          '..'
                FCB     'P,'R,'N,'T              ; FAFF: 50 52 4E 54    'PRNT'
                FDB     PUNCH                    ; FB03: F7 1A          '..'
                FCB     'P,'N,'C,'H              ; FB05: 50 4E 43 48    'PNCH'
                FDB     PUNCH                    ; FB09: F7 1A          '..'
                FCB     'M,'A,'I,'D              ; FB0B: 4D 41 49 44    'MAID'
                FDB     MAID                     ; FB0F: F0 ED          '..'
                FCB     'S,'1,'0,'.              ; FB11: 53 31 30 2E    'S10.'
                FDB     S10                      ; FB15: FA CD          '..'
                FCB     'S,'3,'0,'.              ; FB17: 53 33 30 2E    'S30.'
                FDB     S30                      ; FB1B: FA DA          '..'
                FCB     'S,'1,'2,'0              ; FB1D: 53 31 32 30    'S120'
                FDB     S120                     ; FB21: FA E1          '..'
                FCB     'S,'2,'4,'0              ; FB23: 53 32 34 30    'S240'
                FDB     S240                     ; FB27: FA E8          '..'
                FCB     'T,'E,'R,'M              ; FB29: 54 45 52 4D    'TERM'
                FDB     TERM                     ; FB2D: F6 27          '.''
GREETING        FCB     'E,'X,'B,'U,'G,' ,'1,'.  ; FB2F: 45 58 42 55 47 20 31 2E 'EXBUG 1.'
                FCB     '2,'                     ; FB37: 32 20          '2 '
                FCB     $04                      ; FB39: 04             '.'
BEGINADDR       FCB     'B,'E,'G,' ,'A,'D,'D,'R  ; FB3A: 42 45 47 20 41 44 44 52 'BEG ADDR'
                FCB     '                        ; FB42: 20             ' '
                FCB     $04                      ; FB43: 04             '.'
ENDADDR         FCB     'E,'N,'D,' ,'A,'D,'D,'R  ; FB44: 45 4E 44 20 41 44 44 52 'END ADDR'
                FCB     '                        ; FB4C: 20             ' '
                FCB     $04                      ; FB4D: 04             '.'
CONTLDVERF      FCB     'C,'O,'N,'T,'/,'L,'O,'A  ; FB4E: 43 4F 4E 54 2F 4C 4F 41 'CONT/LOA'
                FCB     'D,'/,'V,'E,'R,'F,'      ; FB56: 44 2F 56 45 52 46 20 'D/VERF '
                FCB     $04                      ; FB5D: 04             '.'
NOCHNGE         FCB     'N,'O,' ,'C,'H,'A,'N,'G  ; FB5E: 4E 4F 20 43 48 41 4E 47 'NO CHANG'
                FCB     'E                       ; FB66: 45             'E'
                FCB     $07,$04                  ; FB67: 07 04          '..'
CHECKSM         FCB     'C,'K,'S,'M,'            ; FB69: 43 4B 53 4D 20 'CKSM '
                FCB     $04                      ; FB6E: 04             '.'
ADRMEMTAP       FCB     'A,'D,'D,'R,'/,'M,'E,'M  ; FB6F: 41 44 44 52 2F 4D 45 4D 'ADDR/MEM'
                FCB     '/,'T,'A,'P,'E           ; FB77: 2F 54 41 50 45 '/TAPE'
                FCB     $04                      ; FB7C: 04             '.'
INVALID         FCB     ' ,'I,'N,'V,'L           ; FB7D: 20 49 4E 56 4C ' INVL'
                FCB     $04                      ; FB82: 04             '.'
EXEC            FCB     'E,'X,'E,'C,'            ; FB83: 45 58 45 43 20 'EXEC '
                FCB     $04                      ; FB88: 04             '.'
SGLCONT         FCB     'S,'G,'L,'/,'C,'O,'N,'T  ; FB89: 53 47 4C 2F 43 4F 4E 54 'SGL/CONT'
                FCB     '                        ; FB91: 20             ' '
                FCB     $04                      ; FB92: 04             '.'
STOPONADDR      FCB     'S,'T,'O,'P,'-,'O,'N,'-  ; FB93: 53 54 4F 50 2D 4F 4E 2D 'STOP-ON-'
                FCB     'A,'D,'D,'R,'E,'S,'S,'   ; FB9B: 41 44 44 52 45 53 53 20 'ADDRESS '
                FCB     $04                      ; FBA3: 04             '.'
STOPADDR        FCB     'S,'T,'O,'P,' ,'A,'D,'D  ; FBA4: 53 54 4F 50 20 41 44 44 'STOP ADD'
                FCB     'R,'                     ; FBAC: 52 20          'R '
                FCB     $04                      ; FBAE: 04             '.'
ABORTED         FCB     'A,'B,'O,'R,'T,'E,'D,'   ; FBAF: 41 42 4F 52 54 45 44 20 'ABORTED '
                FCB     'A,'T,'                  ; FBB7: 41 54 20       'AT '
                FCB     $04                      ; FBBA: 04             '.'
...
MFBC6           FCB     '*                       ; FBC6: 2A             '*'
                FCB     $04                      ; FBC7: 04             '.'
BKPTERR         FCB     'B,'K,'P,'T,' ,'E,'R,'R  ; FBC8: 42 4B 50 54 20 45 52 52 'BKPT ERR'
                FCB     'O,'R,'                  ; FBD0: 4F 52 20       'OR '
                FCB     $04                      ; FBD3: 04             '.'
S1_TXT          FCB     $0d,$0a,$00              ; FBD4: 0D 0A 00       '...'
                FCB     'S,'1                    ; FBD7: 53 31          'S1'
                FCB     $04                      ; FBD9: 04             '.'
S9_TXT          FCB     $0d,$0a,$00              ; FBDA: 0D 0A 00       '...'
                FCB     'S,'9,'0,'3,'0,'0,'0,'0  ; FBDD: 53 39 30 33 30 30 30 30 'S9030000'
                FCB     'F,'C                    ; FBE5: 46 43          'FC'
                FCB     $0d,$04                  ; FBE7: 0D 04          '..'
S0_TXT          FCB     $0d,$0a,$00              ; FBE9: 0D 0A 00       '...'
                FCB     'S,'0,'0,'B,'0,'0,'0,'0  ; FBEC: 53 30 30 42 30 30 30 30 'S00B0000'
                FCB     '5,'8,'2,'0              ; FBF4: 35 38 32 30    '5820'
                FCB     $04                      ; FBF8: 04             '.'
HD_TXT          FCB     'H,'D                    ; FBF9: 48 44          'HD'
RTNUSR          FCB     'R,'=,'X,'               ; FBFB: 52 3D 58 20    'R=X '
                FCB     $04                      ; FBFF: 04             '.'
