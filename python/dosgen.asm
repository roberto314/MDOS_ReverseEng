...
Z2077           LDAB    #$0B                     ; 2077: C6 0B          
                CPX     #MC600                   ; 2079: 8C C6 00       
                CPX     #MC601                   ; 207C: 8C C6 01       
                CPX     #MC604                   ; 207F: 8C C6 04       
                CPX     #MC606                   ; 2082: 8C C6 06       
                SWI                              ; 2085: 3F             
                BRA     Z20A8                    ; 2086: 20 20          
                FCB     $EC                      ; 2088: EC             
Z2089           LDAA    M0021                    ; 2089: 96 21          
                STAA    M0000                    ; 208B: 97 00          
...
Z2189           LDX     #M294B                   ; 2189: CE 29 4B       
                ...
                STAA    M0000                    ; 2190: 97 00          
                LDAA    #$18                     ; 2192: 86 18          
                STAA    M0002                    ; 2194: 97 02          
                LDAB    #$00                     ; 2196: C6 00          
                STAB    M0001                    ; 2198: D7 01          
                LDX     M002A                    ; 219A: DE 2A          
                SWI                              ; 219C: 3F             
                BLT     Z217E                    ; 219D: 2D DF          
                FCB     $03                      ; 219F: 03             
                LDX     #M27CC                   ; 21A0: CE 27 CC       
                STX     M0006                    ; 21A3: DF 06          
...
Z21CC           STX     M0009                    ; 21CC: DF 09          
                LDX     #M0008                   ; 21CE: CE 00 08       
                JMP     Z207D                    ; 21D1: 7E 20 7D       
Z21D4           LDAB    M0020                    ; 21D4: D6 20          
Z21D6           BNE     Z21DD                    ; 21D6: 26 05          
...
Z220A           LDX     M0001                    ; 220A: DE 01          
                ...
                LDAB    #$81                     ; 2222: C6 81          
                SWI                              ; 2224: 3F             
                BLS     Z2205                    ; 2225: 23 DE          
                NOP                              ; 2227: 01             
                INX                              ; 2228: 08             
                CPX     M002A                    ; 2229: 9C 2A          
                BEQ     Z21B4                    ; 222B: 27 87          
                STX     M0001                    ; 222D: DF 01          
                LDX     M0026                    ; 222F: DE 26          
                STX     M0003                    ; 2231: DF 03          
...
Z227B           LDX     #M28F7                   ; 227B: CE 28 F7       
                ...
                LDAB    #$80                     ; 2282: C6 80          
                SWI                              ; 2284: 3F             
                BLS     Z22A7                    ; 2285: 23 20          
                LDS     $CE,X                    ; 2287: AE CE          
                BVC     Z2243                    ; 2289: 28 B8          
                SWI                              ; 228B: 3F             
                CLC                              ; 228C: 0C             
                LDAB    #$03                     ; 228D: C6 03          
...
Z22E0           LDAA    M27B8                    ; 22E0: B6 27 B8       
                SWI                              ; 22E3: 3F             
                BLE     Z2309                    ; 22E4: 2F 23          
                SUBB    $CE,X                    ; 22E6: E0 CE          
                BVC     Z22BE                    ; 22E8: 28 D4          
                SWI                              ; 22EA: 3F             
                CLV                              ; 22EB: 0A             
Z22EC           LDX     #M2630                   ; 22EC: CE 26 30       
                ...
                SWI                              ; 22F7: 3F             
                BEQ     Z2290                    ; 22F8: 27 96          
                BLT     Z22A6                    ; 22FA: 2D AA          
                FCB     $00                      ; 22FC: 00             
                STAA    ,X                       ; 22FD: A7 00          
                INX                              ; 22FF: 08             
                SUBB    #$80                     ; 2300: C0 80          
                ...
                STAA    M0000                    ; 232F: 97 00          
                LDX     #M0003                   ; 2331: CE 00 03       
                STX     M0001                    ; 2334: DF 01          
                LDX     #M0014                   ; 2336: CE 00 14       
                STX     M0003                    ; 2339: DF 03          
                LDX     #M27CE                   ; 233B: CE 27 CE       
                STX     M0006                    ; 233E: DF 06          
...
Z234E           LDX     #M444B                   ; 234E: CE 44 4B       
                ...
                LDAB    #$36                     ; 2374: C6 36          
                SWI                              ; 2376: 3F             
                BRA     Z23B8                    ; 2377: 20 3F          
                FCB     $1A                      ; 2379: 1A             
Z237A           SWI                              ; 237A: 3F             
                BVS     Z2386                    ; 237B: 29 09          
...
Z2419           LDX     M0028                    ; 2419: DE 28          
                ...
                LDAB    #$0A                     ; 2423: C6 0A          
                SWI                              ; 2425: 3F             
                BEQ     Z2407                    ; 2426: 27 DF          
                BVC     Z244A                    ; 2428: 28 20          
                TAP                              ; 242A: 06             
Z242B           LDX     #M2790                   ; 242B: CE 27 90       
                STX     M27AD                    ; 242E: FF 27 AD       
                LDX     #M26D0                   ; 2431: CE 26 D0       
...
Z2444           STX     M2923                    ; 2444: FF 29 23       
                LDX     #M26D0                   ; 2447: CE 26 D0       
Z244A           STX     M27AD                    ; 244A: FF 27 AD       
...
Z249B           LDAB    #$12                     ; 249B: C6 12          
                SEC                              ; 249D: 0D             
Z249E           RTS                              ; 249E: 39             
Z249F           LDX     M0003                    ; 249F: DE 03          
                LDAA    M0002                    ; 24A1: 96 02          
                LDAB    M0001                    ; 24A3: D6 01          
                SWI                              ; 24A5: 3F             
                BPL     Z2486                    ; 24A6: 2A DE          
                SEV                              ; 24A8: 0B             
                INX                              ; 24A9: 08             
                SWI                              ; 24AA: 3F             
                BGT     Z2444                    ; 24AB: 2E 97          
                FCB     $02                      ; 24AD: 02             
                STAB    M0001                    ; 24AE: D7 01          
                RTS                              ; 24B0: 39             
...
Z24EE           LDX     M0028                    ; 24EE: DE 28          
                ...
                LDAB    #$0A                     ; 24F7: C6 0A          
                SWI                              ; 24F9: 3F             
                BEQ     Z24DB                    ; 24FA: 27 DF          
                BVC     Z24CC                    ; 24FC: 28 CE          
                BEQ     Z2490                    ; 24FE: 27 90          
...
Z255C           LDX     #M26C5                   ; 255C: CE 26 C5       
                ...
                LDAA    #$75                     ; 2599: 86 75          
                SWI                              ; 259B: 3F             
                BVC     Z259D                    ; 259C: 28 FF          
                BEQ     Z254F                    ; 259E: 27 AF          
                LDAB    #$0B                     ; 25A0: C6 0B          
...
M25B0           LDAA    ME800                    ; 25B0: B6 E8 00       
                ...
                ADDA    #$01                     ; 25D5: 8B 01          
                ADCB    #$00                     ; 25D7: C9 00          
                STAB    M0001                    ; 25D9: D7 01          
                STAA    M0002                    ; 25DB: 97 02          
                ...
                STAA    M0004                    ; 25E7: 97 04          
                STAB    M0003                    ; 25E9: D7 03          
                LDX     $78,X                    ; 25EB: EE 78          
                STX     M0006                    ; 25ED: DF 06          
                LDX     #M0007                   ; 25EF: CE 00 07       
Z25F2           ASLA                             ; 25F2: 48             
                ROLB                             ; 25F3: 59             
                DEX                              ; 25F4: 09             
                BNE     Z25F2                    ; 25F5: 26 FB          
                ADDA    M0007                    ; 25F7: 9B 07          
                ADCB    M0006                    ; 25F9: D9 06          
                STAA    M000C                    ; 25FB: 97 0C          
                STAB    M000B                    ; 25FD: D7 0B          
...
Z2602           LDAA    #$AA                     ; 2602: 86 AA          
                ...
                CPX     M000B                    ; 2611: 9C 0B          
                BNE     Z2602                    ; 2613: 26 ED          
                CLR     M0000                    ; 2615: 7F 00 00       
                LDAA    #$53                     ; 2618: 86 53          
                PSHA                             ; 261A: 36             
                LDAA    #$E8                     ; 261B: 86 E8          
                PSHA                             ; 261D: 36             
                JMP     ZE86D                    ; 261E: 7E E8 6D       
Z2621           STX     M0000                    ; 2621: DF 00          
                LDAA    #$4D                     ; 2623: 86 4D          
                CPX     #M863F                   ; 2625: 8C 86 3F       
Z2628           STAA    M0008                    ; 2628: 97 08          
                COMB                             ; 262A: 53             
...
M289A           FCB     'E,'N,'T,'E,'R,' ,'S,'T  ; 289A: 45 4E 54 45 52 20 53 54 
                ...
                FCB     $04                      ; 28B7: 04             
                FCB     'E,'N,'T,'E,'R,' ,'E,'N  ; 28B8: 45 4E 54 45 52 20 45 4E 
                FCB     'D,'I,'N,'G,' ,'S,'E,'C  ; 28C0: 44 49 4E 47 20 53 45 43 
                FCB     'T,'O,'R,' ,'(,'H,'H,'H  ; 28C8: 54 4F 52 20 28 48 48 48 
                FCB     '),':,'                  ; 28D0: 29 3A 20       
                FCB     $04                      ; 28D3: 04             
                FCB     'A,'B,'O,'V,'E,' ,'S,'E  ; 28D4: 41 42 4F 56 45 20 53 45 
