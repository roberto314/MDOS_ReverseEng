...
Z1C28           CLR     M1F4F                    ; 1C28: 7F 1F 4F       '..O'
                LDX     $08,X                    ; 1C2B: EE 08          '..'
                STX     M1F30                    ; 1C2D: FF 1F 30       '..0'
...
Z1D18           LDAA    $01,X                    ; 1D18: A6 01          '..'
                ...
                LDX     M1F35                    ; 1D21: FE 1F 35       '..5'
                LDAB    #$3A                     ; 1D24: C6 3A          '.:'
Z1D26           TST     ,X                       ; 1D26: 6D 00          'm.'
...
Z1D32           LDAB    ,X                       ; 1D32: E6 00          '..'
                ...
                JMP     Z1C50                    ; 1D3F: 7E 1C 50       '~.P'
Z1D42           TST     M1F4F                    ; 1D42: 7D 1F 4F       '}.O'
                BEQ     Z1D4A                    ; 1D45: 27 03          ''.'
                JMP     Z1C50                    ; 1D47: 7E 1C 50       '~.P'
Z1D4A           JSR     Z1F13                    ; 1D4A: BD 1F 13       '...'
                SWI                              ; 1D4D: 3F             '?'
                PSHA                             ; 1D4E: 36             '6'
                BEQ     Z1D54                    ; 1D4F: 27 03          ''.'
Z1D51           JMP     Z1E9C                    ; 1D51: 7E 1E 9C       '~..'
Z1D54           TST     $0B,X                    ; 1D54: 6D 0B          'm.'
                ...
                LDX     $04,X                    ; 1D62: EE 04          '..'
                STX     M1F35                    ; 1D64: FF 1F 35       '..5'
                LDAB    #$0A                     ; 1D67: C6 0A          '..'
                LDX     #M1F33                   ; 1D69: CE 1F 33       '..3'
                SWI                              ; 1D6C: 3F             '?'
                CBA                              ; 1D6D: 11             '.'
                BNE     Z1D8C                    ; 1D6E: 26 1C          '&.'
Z1D70           LDX     M1F2E                    ; 1D70: FE 1F 2E       '...'
                LDX     $04,X                    ; 1D73: EE 04          '..'
                STX     M1F33                    ; 1D75: FF 1F 33       '..3'
                ...
                TXS                              ; 1D81: 35             '5'
                LDAB    #$10                     ; 1D82: C6 10          '..'
                LDX     #M1F33                   ; 1D84: CE 1F 33       '..3'
                SWI                              ; 1D87: 3F             '?'
                SBA                              ; 1D88: 10             '.'
                JMP     Z1C50                    ; 1D89: 7E 1C 50       '~.P'
...
Z1DA6           LDX     M1F30                    ; 1DA6: FE 1F 30       '..0'
                LDAA    #$40                     ; 1DA9: 86 40          '.@'
...
Z1E45           TST     M1F4F                    ; 1E45: 7D 1F 4F       '}.O'
                BEQ     Z1E4D                    ; 1E48: 27 03          ''.'
                JMP     Z1C50                    ; 1E4A: 7E 1C 50       '~.P'
Z1E4D           LDX     M1F2E                    ; 1E4D: FE 1F 2E       '...'
                LDX     $04,X                    ; 1E50: EE 04          '..'
                STX     M1F4B                    ; 1E52: FF 1F 4B       '..K'
                LDX     M1F2E                    ; 1E55: FE 1F 2E       '...'
                LDX     $06,X                    ; 1E58: EE 06          '..'
                STX     M1F4D                    ; 1E5A: FF 1F 4D       '..M'
...
Z1F13           LDX     M1F2E                    ; 1F13: FE 1F 2E       '...'
                ...
                RTS                              ; 1F1C: 39             '9'
Z1F1D           LDX     M1F30                    ; 1F1D: FE 1F 30       '..0'
                LDX     $02,X                    ; 1F20: EE 02          '..'
                JSR     $06,X                    ; 1F22: AD 06          '..'
                FCB     $1F                      ; 1F24: 1F             '.'
