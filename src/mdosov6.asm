...
Z2000           LDX     #M216A                   ; 2000: CE 21 6A       '.!j'
                LDAB    #$03                     ; 2003: C6 03          '..'
                SWI                              ; 2005: 3F             '?'
                SBA                              ; 2006: 10             '.'
...
Z200E           CLRB                             ; 200E: 5F             '_'
                LDX     #M2165                   ; 200F: CE 21 65       '.!e'
                SWI                              ; 2012: 3F             '?'
                CLI                              ; 2013: 0E             '.'
                LDX     M2168                    ; 2014: FE 21 68       '.!h'
                LDX     $08,X                    ; 2017: EE 08          '..'
                STX     M213B                    ; 2019: FF 21 3B       '.!;'
                CPX     M0100                    ; 201C: BC 01 00       '...'
                BNE     Z2046                    ; 201F: 26 25          '&%'
                LDX     M2168                    ; 2021: FE 21 68       '.!h'
                LDX     $0A,X                    ; 2024: EE 0A          '..'
                STX     M213E                    ; 2026: FF 21 3E       '.!>'
                CPX     M0102                    ; 2029: BC 01 02       '...'
                BNE     Z2046                    ; 202C: 26 18          '&.'
                LDX     #M11C2                   ; 202E: CE 11 C2       '...'
                STX     M216A                    ; 2031: FF 21 6A       '.!j'
                LDX     #M2197                   ; 2034: CE 21 97       '.!.'
                STX     M216C                    ; 2037: FF 21 6C       '.!l'
                LDAB    #$0E                     ; 203A: C6 0E          '..'
                LDX     #M216A                   ; 203C: CE 21 6A       '.!j'
                SWI                              ; 203F: 3F             '?'
                CBA                              ; 2040: 11             '.'
                BEQ     Z2063                    ; 2041: 27 20          '' '
                LDAA    #$52                     ; 2043: 86 52          '.R'
                CPX     #M8649                   ; 2045: 8C 86 49       '..I'
Z2048           STAA    PUTLS                    ; 2048: 97 08          '..'
Z204A           SEC                              ; 204A: 0D             '.'
                JSR     CHKERR                   ; 204B: BD E8 53       '..S'
...
Z2081           LDX     #M0120                   ; 2081: CE 01 20       '.. '
                ...
                LDX     #M2135                   ; 20A8: CE 21 35       '.!5'
                SWI                              ; 20AB: 3F             '?'
                SEV                              ; 20AC: 0B             '.'
Z20AD           LDAA    #$3D                     ; 20AD: 86 3D          '.='
                STAA    M0133                    ; 20AF: B7 01 33       '..3'
                LDX     #M00AE                   ; 20B2: CE 00 AE       '...'
                LDAB    #$4F                     ; 20B5: C6 4F          '.O'
                SWI                              ; 20B7: 3F             '?'
                SEC                              ; 20B8: 0D             '.'
                SWI                              ; 20B9: 3F             '?'
                DEX                              ; 20BA: 09             '.'
                CLRB                             ; 20BB: 5F             '_'
                STAB    M0133                    ; 20BC: F7 01 33       '..3'
                ...
                STX     M2141                    ; 20CF: FF 21 41       '.!A'
                LDX     #M2145                   ; 20D2: CE 21 45       '.!E'
                STX     M2143                    ; 20D5: FF 21 43       '.!C'
                LDAA    #$30                     ; 20D8: 86 30          '.0'
                STAA    ,X                       ; 20DA: A7 00          '..'
                STAA    $01,X                    ; 20DC: A7 01          '..'
                LDX     #M434D                   ; 20DE: CE 43 4D       '.CM'
Z20E1           STX     M214E                    ; 20E1: FF 21 4E       '.!N'
                LDX     #M2141                   ; 20E4: CE 21 41       '.!A'
                SWI                              ; 20E7: 3F             '?'
                FCB     $1D                      ; 20E8: 1D             '.'
                TSTB                             ; 20E9: 5D             ']'
                BNE     Z2121                    ; 20EA: 26 35          '&5'
                LDAB    M2145                    ; 20EC: F6 21 45       '.!E'
                CMPB    #$30                     ; 20EF: C1 30          '.0'
                BLT     Z2121                    ; 20F1: 2D 2E          '-.'
                CMPB    #$33                     ; 20F3: C1 33          '.3'
                BGT     Z2121                    ; 20F5: 2E 2A          '.*'
                LDX     M2141                    ; 20F7: FE 21 41       '.!A'
                STX     M00FE                    ; 20FA: DF FE          '..'
                LDAB    #$11                     ; 20FC: C6 11          '..'
                LDX     #M2145                   ; 20FE: CE 21 45       '.!E'
                SWI                              ; 2101: 3F             '?'
                ABA                              ; 2102: 1B             '.'
                CMPB    #$03                     ; 2103: C1 03          '..'
...
M2135           FCB     $0D                      ; 2135: 0D             '.'
                FCB     $4D,$44,$4F,$53,$20      ; 2136: 4D 44 4F 53 20 'MDOS '
...
M214E           FCB     $00,$00,$00,$00,$00,$00  ; 214E: 00 00 00 00 00 00 '......'
                ...
                FCB     $21,$71,$21              ; 215A: 21 71 21       '!q!'
                FCB     $F0                      ; 215D: F0             '.'
M215E           FCB     $57,$48,$41,$54,$3F      ; 215E: 57 48 41 54 3F 'WHAT?'
                FCB     $07,$04                  ; 2163: 07 04          '..'
M2165           FCB     $00,$00,$00              ; 2165: 00 00 00       '...'
M2168           FCB     $21,$71                  ; 2168: 21 71          '!q'
M216A           FCB     $21,$6E                  ; 216A: 21 6E          '!n'
