...
Loaded: binary file "format.sy"
Loaded: Info file "format.info"
...
M2000           FCB     '0,'3,'0,'0              ; 2000: 30 33 30 30    
M2004           FCB     $E5,$E5                  ; 2004: E5 E5          
FORMATSTART     STS     M0027                    ; 2006: 9F 27          
                LDAA    MEBFF                    ; 2008: B6 EB FF       
                CMPA    #$45                     ; 200B: 81 45          
...
Z2024           STAB    ONECONH                  ; 2024: D7 24          
                ...
                BNE     Z2015                    ; 2040: 26 D3          
                CMPA    M2338                    ; 2042: B1 23 38       
                BNE     Z2015                    ; 2045: 26 CE          
...
Z208C           STAB    PIAREGB                  ; 208C: F7 EC 01       
                ...
                LSRB                             ; 2093: 54             
Z2094           STAB    PIAREGA                  ; 2094: F7 EC 00       
...
Z2152           JSR     SEEK                     ; 2152: BD E8 78       
                BCS     Z20F4                    ; 2155: 25 9D          
                LDAA    ONECONH                  ; 2157: 96 24          
                LSRA                             ; 2159: 44             
                LSRA                             ; 215A: 44             
                LSRA                             ; 215B: 44             
                LSRA                             ; 215C: 44             
                ADDA    EXADDRH                  ; 215D: 9B 22          
...
Z2291           LDAA    STRSCTL                  ; 2291: 96 02          
                ...
                INC     EXADDRH                  ; 229D: 7C 00 22       
                LDAA    LDADDRL                  ; 22A0: 96 21          
                CMPA    EXADDRH                  ; 22A2: 91 22          
                BCS     Z22A9                    ; 22A4: 25 03          
                JMP     Z2152                    ; 22A6: 7E 21 52       
Z22A9           SWI                              ; 22A9: 3F             
                FCB     $1A                      ; 22AA: 1A             
