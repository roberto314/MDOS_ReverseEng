...
M25DE           FCB     'W,'D,'S,'C,'N,'0        ; 25DE: 57 44 53 43 4E 30 
...
M262E           FCB     '*,'N,'O,' ,'S,'D,'W,''  ; 262E: 2A 4E 4F 20 53 44 57 27 
                FCB     'S,'*,'                  ; 2636: 53 2A 20       
M2639           FCB     'N,'O,' ,'D,'I,'R,'E,'C  ; 2639: 4E 4F 20 44 49 52 45 43 
                FCB     'T,'O,'R,'Y,' ,'E,'N,'T  ; 2641: 54 4F 52 59 20 45 4E 54 
                FCB     'R,'Y,' ,'F,'O,'U,'N,'D  ; 2649: 52 59 20 46 4F 55 4E 44 
                FCB     $0d                      ; 2651: 0D             
M2652           FCB     'T,'O,'T,'A,'L,' ,'N,'U  ; 2652: 54 4F 54 41 4C 20 4E 55 
                FCB     'M,'B,'E,'R,' ,'O,'F,'   ; 265A: 4D 42 45 52 20 4F 46 20 
                FCB     'S,'E,'C,'T,'O,'R,'S,'   ; 2662: 53 45 43 54 4F 52 53 20 
                FCB     ':,' ,' ,' ,'            ; 266A: 3A 20 20 20 20 
M266F           FCB     ' ,'/,'$,' ,'            ; 266F: 20 2F 24 20 20 
M2674           FCB     '                        ; 2674: 20             
                FCB     $0d                      ; 2675: 0D             
M2676           FCB     'T,'O,'T,'A,'L,' ,'D,'I  ; 2676: 54 4F 54 41 4C 20 44 49 
                FCB     'R,'E,'C,'T,'O,'R,'Y,'   ; 267E: 52 45 43 54 4F 52 59 20 
                FCB     'E,'N,'T,'R,'I,'E,'S,'   ; 2686: 45 4E 54 52 49 45 53 20 
                FCB     'S,'H,'O,'W,'N,' ,':,'   ; 268E: 53 48 4F 57 4E 20 3A 20 
                FCB     ' ,'                     ; 2696: 20 20          
M2698           FCB     ' ,'/,'$,'               ; 2698: 20 2F 24 20    
M269C           FCB     '                        ; 269C: 20             
                FCB     $0d                      ; 269D: 0D             
M269E           FCB     'N,'O,' ,'T,'E,'R,'M,'I  ; 269E: 4E 4F 20 54 45 52 4D 49 
                FCB     'N,'A,'T,'O,'R,' ,'F,'O  ; 26A6: 4E 41 54 4F 52 20 46 4F 
                FCB     'U,'N,'D,' ,'I,'N,' ,'F  ; 26AE: 55 4E 44 20 49 4E 20 46 
                FCB     'I,'L,'E,'','S,' ,'R,'.  ; 26B6: 49 4C 45 27 53 20 52 2E 
                FCB     'I,'.,'B,'.              ; 26BE: 49 2E 42 2E    
                FCB     $0d                      ; 26C2: 0D             
Z26C3           TSTB                             ; 26C3: 5D             
