...
M1C41           NEGA                             ; 1C41: 40             '@'
                ...
                SEC                              ; 1C4F: 0D             '.'
                FCB     $72                      ; 1C50: 72             'r'
                COM     M696F                    ; 1C51: 73 69 6F       'sio'
                JMP     $20,X                    ; 1C54: 6E 20          'n '
                BLS     Z1C78                    ; 1C56: 23 20          '# '
                LSR     M6F20                    ; 1C58: 74 6F 20       'to '
Z1C5B           ASLB                             ; 1C5B: 58             'X'
                ASLB                             ; 1C5C: 58             'X'
                FCB     $3A                      ; 1C5D: 3A             ':'
                ASLB                             ; 1C5E: 58             'X'
                ASLB                             ; 1C5F: 58             'X'
                ...
                BRA     Z1CAC                    ; 1C65: 20 45          ' E'
                BGT     Z1CAC                    ; 1C67: 2E 43          '.C'
                TSTA                             ; 1C69: 4D             'M'
                BRA     Z1CE2                    ; 1C6A: 20 76          ' v'
                FCB     $65                      ; 1C6C: 65             'e'
                FCB     $72                      ; 1C6D: 72             'r'
                COM     M696F                    ; 1C6E: 73 69 6F       'sio'
                JMP     $20,X                    ; 1C71: 6E 20          'n '
                PULB                             ; 1C73: 33             '3'
                BGT     Z1CA7                    ; 1C74: 2E 31          '.1'
Z1C76           DES                              ; 1C76: 34             '4'
                BRA     Z1CE8                    ; 1C77: 20 6F          ' o'
                FCB     $72                      ; 1C79: 72             'r'
                BRA     Z1CE8                    ; 1C7A: 20 6C          ' l'
                FCB     $61                      ; 1C7C: 61             'a'
                LSR     M6572                    ; 1C7D: 74 65 72       'ter'
                FCB     $21                      ; 1C80: 21             '!'
                SEC                              ; 1C81: 0D             '.'
                BRA     Z1CF2                    ; 1C82: 20 6E          ' n'
                FCB     $75                      ; 1C84: 75             'u'
                TST     $62,X                    ; 1C85: 6D 62          'mb'
                FCB     $65                      ; 1C87: 65             'e'
                FCB     $72                      ; 1C88: 72             'r'
                COM     M290D                    ; 1C89: 73 29 0D       's).'
...
M1D1C           FCB     $00                      ; 1D1C: 00             '.'
                FCB     $00                      ; 1D1D: 00             '.'
M1D1E           FCB     $45                      ; 1D1E: 45             'E'
                FCB     $4E                      ; 1D1F: 4E             'N'
                LSRA                             ; 1D20: 44             'D'
                BRA     Z1D66                    ; 1D21: 20 43          ' C'
                ASLA                             ; 1D23: 48             'H'
                FCB     $41                      ; 1D24: 41             'A'
                ROLA                             ; 1D25: 49             'I'
                FCB     $4E                      ; 1D26: 4E             'N'
...
Z1D2B           LDAA    M0114                    ; 1D2B: B6 01 14       '...'
                ...
                LDAB    #$31                     ; 1D3A: C6 31          '.1'
Z1D3C           JMP     Z1F11                    ; 1D3C: 7E 1F 11       '~..'
Z1D3F           SWI                              ; 1D3F: 3F             '?'
                SEC                              ; 1D40: 0D             '.'
                BCC     Z1D47                    ; 1D41: 24 04          '$.'
Z1D43           LDAB    #$30                     ; 1D43: C6 30          '.0'
                BRA     Z1D3C                    ; 1D45: 20 F5          ' .'
Z1D47           LDX     M1C39                    ; 1D47: FE 1C 39       '..9'
...
Z1D65           LDX     M1D16                    ; 1D65: FE 1D 16       '...'
                STX     M1C39                    ; 1D68: FF 1C 39       '..9'
Z1D6B           JSR     Z1E81                    ; 1D6B: BD 1E 81       '...'
                SWI                              ; 1D6E: 3F             '?'
                SEC                              ; 1D6F: 0D             '.'
                BCS     Z1D43                    ; 1D70: 25 D1          '%.'
                LDX     #M1C41                   ; 1D72: CE 1C 41       '..A'
                LDAA    ,X                       ; 1D75: A6 00          '..'
                CMPA    #$40                     ; 1D77: 81 40          '.@'
                BEQ     Z1DBE                    ; 1D79: 27 43          ''C'
                CMPA    #$5C                     ; 1D7B: 81 5C          '.\'
...
Z1DBE           LDAA    $01,X                    ; 1DBE: A6 01          '..'
                ...
                CMPA    #$4A                     ; 1DCB: 81 4A          '.J'
                BEQ     Z1E43                    ; 1DCD: 27 74          ''t'
                CMPA    #$43                     ; 1DCF: 81 43          '.C'
                BEQ     Z1E39                    ; 1DD1: 27 66          ''f'
                CMPA    #$4C                     ; 1DD3: 81 4C          '.L'
                BEQ     Z1E36                    ; 1DD5: 27 5F          ''_'
                STX     M1D1A                    ; 1DD7: FF 1D 1A       '...'
                JSR     Z1EF8                    ; 1DDA: BD 1E F8       '...'
                CMPA    #$53                     ; 1DDD: 81 53          '.S'
                BNE     Z1DE4                    ; 1DDF: 26 03          '&.'
                JMP     Z1E64                    ; 1DE1: 7E 1E 64       '~.d'
Z1DE4           STX     M1D1C                    ; 1DE4: FF 1D 1C       '...'
                JSR     Z1EF8                    ; 1DE7: BD 1E F8       '...'
                CMPA    #$54                     ; 1DEA: 81 54          '.T'
                BEQ     Z1E13                    ; 1DEC: 27 25          ''%'
                LDAB    #$32                     ; 1DEE: C6 32          '.2'
                BRA     Z1DAB                    ; 1DF0: 20 B9          ' .'
Z1DF2           PSHA                             ; 1DF2: 36             '6'
                LDAB    M1C18                    ; 1DF3: F6 1C 18       '...'
                BEQ     Z1DFD                    ; 1DF6: 27 05          ''.'
                LDX     #M1C41                   ; 1DF8: CE 1C 41       '..A'
                SWI                              ; 1DFB: 3F             '?'
                CLV                              ; 1DFC: 0A             '.'
Z1DFD           PULA                             ; 1DFD: 32             '2'
                CMPA    #$2E                     ; 1DFE: 81 2E          '..'
                BNE     Z1E36                    ; 1E00: 26 34          '&4'
...
Z1E34           PULA                             ; 1E34: 32             '2'
                TAP                              ; 1E35: 06             '.'
Z1E36           JMP     Z1D6B                    ; 1E36: 7E 1D 6B       '~.k'
...
Z1E49           JSR     Z1E7E                    ; 1E49: BD 1E 7E       '..~'
                LDX     M1C41                    ; 1E4C: FE 1C 41       '..A'
                CPX     #M404C                   ; 1E4F: 8C 40 4C       '.@L'
                BNE     Z1E49                    ; 1E52: 26 F5          '&.'
                LDX     #M1C41                   ; 1E54: CE 1C 41       '..A'
...
Z1EEE           JMP     Z1D61                    ; 1EEE: 7E 1D 61       '~.a'
...
Z1F12           BRA     Z1F12                    ; 1F12: 20 FE          ' .'
                ...
                SWI                              ; 1F26: 3F             '?'
                FCB     $1A                      ; 1F27: 1A             '.'
Z1F28           CLR     $02,X                    ; 1F28: 6F 02          'o.'
                CLR     $03,X                    ; 1F2A: 6F 03          'o.'
                LDAB    #$04                     ; 1F2C: C6 04          '..'
                LDX     ,X                       ; 1F2E: EE 00          '..'
Z1F30           LDAA    ,X                       ; 1F30: A6 00          '..'
                SUBA    #$30                     ; 1F32: 80 30          '.0'
...
Z1F44           INX                              ; 1F44: 08             '.'
                ...
                PSHB                             ; 1F48: 37             '7'
                LDAB    #$04                     ; 1F49: C6 04          '..'
Z1F4B           ASL     M1D19                    ; 1F4B: 78 1D 19       'x..'
                ROL     M1D18                    ; 1F4E: 79 1D 18       'y..'
                DECB                             ; 1F51: 5A             'Z'
