...
Loaded: binary file "dir.sy"
Loaded: Info file "dir.info"
...
Z2459           LDAA    #$04                     ; 2459: 86 04          
                ...
                RTS                              ; 2464: 39             
M2465           FCB     '0                       ; 2465: 30             
M2466           FCB     ' ,' ,' ,' ,' ,' ,' ,'   ; 2466: 20 20 20 20 20 20 20 20 
M246E           FCB     ' ,'                     ; 246E: 20 20          
...
M2476           FCB     $00,$00,$00,$00          ; 2476: 00 00 00 00    
                ...
                FCB     $d1                      ; 247B: D1             
                FCB     '%,'P                    ; 247C: 25 50          
M247E           FCB     'D,'R,'I,'V,'E,' ,':,'   ; 247E: 44 52 49 56 45 20 3A 20 
M2486           FCB     ' ,' ,' ,' ,'D,'I,'S,'K  ; 2486: 20 20 20 20 44 49 53 4B 
                FCB     ' ,'I,'.,'D,'.,' ,':,'   ; 248E: 20 49 2E 44 2E 20 3A 20 
M2496           FCB     ' ,' ,' ,' ,' ,' ,' ,'   ; 2496: 20 20 20 20 20 20 20 20 
                FCB     $0d                      ; 249E: 0D             
M249F           FCB     ' ,' ,' ,' ,' ,' ,' ,'   ; 249F: 20 20 20 20 20 20 20 20 
M24A7           FCB     '.                       ; 24A7: 2E             
M24A8           FCB     ' ,'                     ; 24A8: 20 20          
M24AA           FCB     $0d                      ; 24AA: 0D             
                FCB     ' ,'                     ; 24AB: 20 20          
M24AD           FCB     ' ,' ,' ,' ,'            ; 24AD: 20 20 20 20 20 
M24B2           FCB     ' ,' ,' ,' ,'            ; 24B2: 20 20 20 20 20 
M24B7           FCB     ' ,'                     ; 24B7: 20 20          
M24B9           FCB     ' ,' ,'                  ; 24B9: 20 20 20       
M24BC           FCB     ' ,' ,'                  ; 24BC: 20 20 20       
M24BF           FCB     '                        ; 24BF: 20             
M24C0           FCB     $0d                      ; 24C0: 0D             
                FCB     ' ,'                     ; 24C1: 20 20          
M24C3           FCB     '                        ; 24C3: 20             
M24C4           FCB     '                        ; 24C4: 20             
M24C5           FCB     ' ,' ,' ,'               ; 24C5: 20 20 20 20    
M24C9           FCB     ' ,' ,' ,'               ; 24C9: 20 20 20 20    
M24CD           FCB     '                        ; 24CD: 20             
                FCB     $0d                      ; 24CE: 0D             
                FCB     $00                      ; 24CF: 00             
M24D0           FCB     $21                      ; 24D0: 21             
M24D1           FCB     $00                      ; 24D1: 00             
                FCB     $00                      ; 24D2: 00             
                FCB     $00                      ; 24D3: 00             
                FCB     $00                      ; 24D4: 00             
                FCB     $00                      ; 24D5: 00             
...
M25D2           FCB     $00                      ; 25D2: 00             
                FCB     $00                      ; 25D3: 00             
M25D4           FCB     $00                      ; 25D4: 00             
                FCB     $00                      ; 25D5: 00             
M25D6           FCB     $00                      ; 25D6: 00             
                FCB     $00                      ; 25D7: 00             
M25D8           FCB     $00                      ; 25D8: 00             
                FCB     $00                      ; 25D9: 00             
M25DA           FCB     $00                      ; 25DA: 00             
                FCB     $00                      ; 25DB: 00             
M25DC           FCB     $00                      ; 25DC: 00             
                FCB     $00                      ; 25DD: 00             
M25DE           ASRB                             ; 25DE: 57             
                LSRA                             ; 25DF: 44             
                COMB                             ; 25E0: 53             
                ...
                FCB     $4E                      ; 25E2: 4E             
                TSX                              ; 25E3: 30             
M25E4           FCB     $00                      ; 25E4: 00             
                FCB     $00                      ; 25E5: 00             
M25E6           FCB     $00                      ; 25E6: 00             
                FCB     $00                      ; 25E7: 00             
M25E8           BRA     Z260A                    ; 25E8: 20 20          
                BRA     Z260C                    ; 25EA: 20 20          
                BRA     Z260E                    ; 25EC: 20 20          
                BRA     Z2610                    ; 25EE: 20 20          
M25F0           BRA     Z2612                    ; 25F0: 20 20          
M25F2           FCB     $00                      ; 25F2: 00             
                FCB     $00                      ; 25F3: 00             
                FCB     $00                      ; 25F4: 00             
                FCB     $00                      ; 25F5: 00             
                FCB     $00                      ; 25F6: 00             
                ...
                FCB     $00                      ; 2608: 00             
                FCB     $00                      ; 2609: 00             
Z260A           FCB     $00                      ; 260A: 00             
                FCB     $00                      ; 260B: 00             
Z260C           FCB     $00                      ; 260C: 00             
                FCB     $00                      ; 260D: 00             
Z260E           FCB     $00                      ; 260E: 00             
                FCB     $00                      ; 260F: 00             
Z2610           FCB     $00                      ; 2610: 00             
                FCB     $00                      ; 2611: 00             
Z2612           FCB     $00                      ; 2612: 00             
                FCB     $00                      ; 2613: 00             
                FCB     $00                      ; 2614: 00             
                FCB     $00                      ; 2615: 00             
                FCB     $00                      ; 2616: 00             
...
M2639           FCB     $4E                      ; 2639: 4E             
                ...
                FCB     $52                      ; 2643: 52             
                ROLB                             ; 2644: 59             
                BRA     Z268C                    ; 2645: 20 45          
                FCB     $4E                      ; 2647: 4E             
                LSRB                             ; 2648: 54             
                FCB     $52                      ; 2649: 52             
                ROLB                             ; 264A: 59             
                BRA     Z2693                    ; 264B: 20 46          
                CLRA                             ; 264D: 4F             
                FCB     $55                      ; 264E: 55             
                FCB     $4E                      ; 264F: 4E             
                LSRA                             ; 2650: 44             
...
M2652           LSRB                             ; 2652: 54             
                ...
                FCB     $41                      ; 2655: 41             
                INCA                             ; 2656: 4C             
                BRA     Z26A7                    ; 2657: 20 4E          
Z2659           FCB     $55                      ; 2659: 55             
                TSTA                             ; 265A: 4D             
                FCB     $42                      ; 265B: 42             
                FCB     $45                      ; 265C: 45             
                FCB     $52                      ; 265D: 52             
                BRA     Z26AF                    ; 265E: 20 4F          
                RORA                             ; 2660: 46             
                BRA     Z26B6                    ; 2661: 20 53          
                FCB     $45                      ; 2663: 45             
                COMA                             ; 2664: 43             
                LSRB                             ; 2665: 54             
                CLRA                             ; 2666: 4F             
                FCB     $52                      ; 2667: 52             
                COMB                             ; 2668: 53             
                BRA     Z26A5                    ; 2669: 20 3A          
                BRA     Z268D                    ; 266B: 20 20          
                BRA     Z268F                    ; 266D: 20 20          
M266F           BRA     Z26A0                    ; 266F: 20 2F          
                BCC     Z2693                    ; 2671: 24 20          
                BRA     Z2695                    ; 2673: 20 20          
                SEC                              ; 2675: 0D             
M2676           LSRB                             ; 2676: 54             
                CLRA                             ; 2677: 4F             
                LSRB                             ; 2678: 54             
                FCB     $41                      ; 2679: 41             
                INCA                             ; 267A: 4C             
                BRA     Z26C1                    ; 267B: 20 44          
                ROLA                             ; 267D: 49             
Z267E           FCB     $52                      ; 267E: 52             
                FCB     $45                      ; 267F: 45             
                COMA                             ; 2680: 43             
Z2681           LSRB                             ; 2681: 54             
                CLRA                             ; 2682: 4F             
...
Z268A           ROLA                             ; 268A: 49             
                FCB     $45                      ; 268B: 45             
Z268C           COMB                             ; 268C: 53             
Z268D           BRA     Z26E2                    ; 268D: 20 53          
Z268F           ASLA                             ; 268F: 48             
                CLRA                             ; 2690: 4F             
                ASRB                             ; 2691: 57             
                FCB     $4E                      ; 2692: 4E             
Z2693           BRA     Z26CF                    ; 2693: 20 3A          
Z2695           BRA     Z26B7                    ; 2695: 20 20          
                BRA     Z26B9                    ; 2697: 20 20          
...
Z26A5           ROLA                             ; 26A5: 49             
                FCB     $4E                      ; 26A6: 4E             
Z26A7           FCB     $41                      ; 26A7: 41             
                LSRB                             ; 26A8: 54             
                CLRA                             ; 26A9: 4F             
                FCB     $52                      ; 26AA: 52             
                BRA     Z26F3                    ; 26AB: 20 46          
                CLRA                             ; 26AD: 4F             
                FCB     $55                      ; 26AE: 55             
Z26AF           FCB     $4E                      ; 26AF: 4E             
                LSRA                             ; 26B0: 44             
                BRA     Z26FC                    ; 26B1: 20 49          
                FCB     $4E                      ; 26B3: 4E             
                BRA     Z26FC                    ; 26B4: 20 46          
Z26B6           ROLA                             ; 26B6: 49             
Z26B7           INCA                             ; 26B7: 4C             
                FCB     $45                      ; 26B8: 45             
Z26B9           BEQ     Z270E                    ; 26B9: 27 53          
                BRA     Z270F                    ; 26BB: 20 52          
Z26BD           BGT     Z2708                    ; 26BD: 2E 49          
Z26BF           BGT     Z2703                    ; 26BF: 2E 42          
Z26C1           BGT     Z26D0                    ; 26C1: 2E 0D          
Z26C3           TSTB                             ; 26C3: 5D             
                BEQ     Z26F5                    ; 26C4: 27 2F          
                INC     $03,X                    ; 26C6: 6C 03          
                BNE     Z26CC                    ; 26C8: 26 02          
                INC     $02,X                    ; 26CA: 6C 02          
Z26CC           STX     Z26F6                    ; 26CC: FF 26 F6       
Z26CF           LDX     Z26F6                    ; 26CF: FE 26 F6       
...
Z26E2           DEC     $02,X                    ; 26E2: 6A 02          
Z26E4           DEC     $03,X                    ; 26E4: 6A 03          
                LDX     $02,X                    ; 26E6: EE 02          
                STAA    ,X                       ; 26E8: A7 00          
                LDX     Z26F6                    ; 26EA: FE 26 F6       
                BSR     Z26F8                    ; 26ED: 8D 09          
                DECB                             ; 26EF: 5A             
                BNE     Z26CF                    ; 26F0: 26 DD          
                LDX     Z26F6                    ; 26F2: FE 26 F6       
Z26F5           RTS                              ; 26F5: 39             
Z26F6           FCB     $00                      ; 26F6: 00             
                FCB     $00                      ; 26F7: 00             
Z26F8           PSHA                             ; 26F8: 36             
                LDAA    #$04                     ; 26F9: 86 04          
