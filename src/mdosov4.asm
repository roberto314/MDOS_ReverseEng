...
OPEN1           JMP     OPEN2                    ; 1C0D: 7E 1C 13       
                JSR     Z1206                    ; 1C10: BD 12 06       
OPEN2           STX     M1F2E                    ; 1C13: FF 1F 2E       
                LDAB    #$10                     ; 1C16: C6 10          
...
Z1E4D           LDX     M1F2E                    ; 1E4D: FE 1F 2E       
                ...
                SWI                              ; 1E64: 3F             
                FCB     $24                      ; 1E65: 24             
                LDX     M1F2E                    ; 1E66: FE 1F 2E       
                STAB    $04,X                    ; 1E69: E7 04          
                ...
                SWI                              ; 1E73: 3F             
                FCB     $24                      ; 1E74: 24             
                LDX     M1F2E                    ; 1E75: FE 1F 2E       
                STAB    $06,X                    ; 1E78: E7 06          
