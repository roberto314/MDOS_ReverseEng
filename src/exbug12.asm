...
Loaded: binary file "exbug12.bin"
Loaded: Info file "exbug12.info"
...
XPDATA          JMP     XPDATA1                  ; F024: 7E FA 14       
...
ZF587           CLR     ,X                       ; F587: 6F 00          
                ...
                LDAA    PROM_1                   ; F5A8: B6 FC FD       
                ANDA    #$3F                     ; F5AB: 84 3F          
                STAA    ACIA_0                   ; F5AD: B7 FC F4       
                BSR     ZF622                    ; F5B0: 8D 70          
                LDAA    #$3A                     ; F5B2: 86 3A          
                BSR     ZF624                    ; F5B4: 8D 6E          
                BSR     ZF622                    ; F5B6: 8D 6A          
                LDAA    #$39                     ; F5B8: 86 39          
                BSR     ZF624                    ; F5BA: 8D 68          
                LDX     #MFBBB                   ; F5BC: CE FB BB       
                JSR     XPDAT1                   ; F5BF: BD FA 16       
REENT3          LDS     #XSTAKs                  ; F5C2: 8E FF 8A       
                BSR     ZF61B                    ; F5C5: 8D 54          
...
ZF614           INX                              ; F614: 08             
                ...
                INX                              ; F619: 08             
                RTS                              ; F61A: 39             
ZF61B           LDX     #M30D4                   ; F61B: CE 30 D4       
ZF61E           DEX                              ; F61E: 09             
                BNE     ZF61E                    ; F61F: 26 FD          
                RTS                              ; F621: 39             
ZF622           LDAA    #$10                     ; F622: 86 10          
ZF624           JMP     OUTCNSF                  ; F624: 7E F9 CF       
...
ZF9DC           BSR     ZFA07                    ; F9DC: 8D 29          
                ...
                LDAA    #$2F                     ; F9E0: 86 2F          
XOUTCH1         BSR     OUTCNSF                  ; F9E2: 8D EB          
                PSHB                             ; F9E4: 37             
                CMPA    #$0D                     ; F9E5: 81 0D          
...
ZFA2E           CMPA    #$58                     ; FA2E: 81 58          
                BNE     ZFA35                    ; FA30: 26 03          
                JMP     REENT3                   ; FA32: 7E F5 C2       
ZFA35           CMPA    #$5E                     ; FA35: 81 5E          
...
MFAED           FCB     'L,'O,'A,'D              ; FAED: 4C 4F 41 44    
                FDB     LOAD                     ; FAF1: F7 B9          
                FCB     'V,'E,'R,'F              ; FAF3: 56 45 52 46    
                FDB     VERIFY                   ; FAF7: F7 BE          
                FCB     'S,'R,'C,'H              ; FAF9: 53 52 43 48    
                FDB     SEARCH                   ; FAFD: F7 B2          
                FCB     'P,'R,'N,'T              ; FAFF: 50 52 4E 54    
                FDB     PUNCH                    ; FB03: F7 1A          
                FCB     'P,'N,'C,'H              ; FB05: 50 4E 43 48    
                FDB     PUNCH                    ; FB09: F7 1A          
                FCB     'M,'A,'I,'D              ; FB0B: 4D 41 49 44    
                FDB     MAID                     ; FB0F: F0 ED          
                FCB     'S,'1,'0,'.              ; FB11: 53 31 30 2E    
                FDB     S10                      ; FB15: FA CD          
                FCB     'S,'3,'0,'.              ; FB17: 53 33 30 2E    
                FDB     S30                      ; FB1B: FA DA          
                FCB     'S,'1,'2,'0              ; FB1D: 53 31 32 30    
                FDB     S120                     ; FB21: FA E1          
                FCB     'S,'2,'4,'0              ; FB23: 53 32 34 30    
                FDB     S240                     ; FB27: FA E8          
                FCB     'T,'E,'R,'M              ; FB29: 54 45 52 4D    
                FDB     TERM                     ; FB2D: F6 27          
GREETING        FCB     'E,'X,'B,'U,'G,' ,'1,'.  ; FB2F: 45 58 42 55 47 20 31 2E 
                FCB     '2,'                     ; FB37: 32 20          
                FCB     $04                      ; FB39: 04             
BEGINADDR       FCB     'B,'E,'G,' ,'A,'D,'D,'R  ; FB3A: 42 45 47 20 41 44 44 52 
                FCB     '                        ; FB42: 20             
                FCB     $04                      ; FB43: 04             
ENDADDR         FCB     'E,'N,'D,' ,'A,'D,'D,'R  ; FB44: 45 4E 44 20 41 44 44 52 
                FCB     '                        ; FB4C: 20             
                FCB     $04                      ; FB4D: 04             
CONTLDVERF      FCB     'C,'O,'N,'T,'/,'L,'O,'A  ; FB4E: 43 4F 4E 54 2F 4C 4F 41 
                FCB     'D,'/,'V,'E,'R,'F,'      ; FB56: 44 2F 56 45 52 46 20 
                FCB     $04                      ; FB5D: 04             
NOCHNGE         FCB     'N,'O,' ,'C,'H,'A,'N,'G  ; FB5E: 4E 4F 20 43 48 41 4E 47 
                FCB     'E                       ; FB66: 45             
                FCB     $07,$04                  ; FB67: 07 04          
CHECKSM         FCB     'C,'K,'S,'M,'            ; FB69: 43 4B 53 4D 20 
                FCB     $04                      ; FB6E: 04             
ADRMEMTAP       FCB     'A,'D,'D,'R,'/,'M,'E,'M  ; FB6F: 41 44 44 52 2F 4D 45 4D 
                FCB     '/,'T,'A,'P,'E           ; FB77: 2F 54 41 50 45 
                FCB     $04                      ; FB7C: 04             
INVALID         FCB     ' ,'I,'N,'V,'L           ; FB7D: 20 49 4E 56 4C 
                FCB     $04                      ; FB82: 04             
EXEC            FCB     'E,'X,'E,'C,'            ; FB83: 45 58 45 43 20 
                FCB     $04                      ; FB88: 04             
SGLCONT         FCB     'S,'G,'L,'/,'C,'O,'N,'T  ; FB89: 53 47 4C 2F 43 4F 4E 54 
                FCB     '                        ; FB91: 20             
                FCB     $04                      ; FB92: 04             
STOPONADDR      FCB     'S,'T,'O,'P,'-,'O,'N,'-  ; FB93: 53 54 4F 50 2D 4F 4E 2D 
                FCB     'A,'D,'D,'R,'E,'S,'S,'   ; FB9B: 41 44 44 52 45 53 53 20 
                FCB     $04                      ; FBA3: 04             
STOPADDR        FCB     'S,'T,'O,'P,' ,'A,'D,'D  ; FBA4: 53 54 4F 50 20 41 44 44 
                FCB     'R,'                     ; FBAC: 52 20          
                FCB     $04                      ; FBAE: 04             
ABORTED         FCB     'A,'B,'O,'R,'T,'E,'D,'   ; FBAF: 41 42 4F 52 54 45 44 20 
                FCB     'A,'T,'                  ; FBB7: 41 54 20       
                FCB     $04                      ; FBBA: 04             
...
MFBC6           FCB     '*                       ; FBC6: 2A             
                FCB     $04                      ; FBC7: 04             
BKPTERR         FCB     'B,'K,'P,'T,' ,'E,'R,'R  ; FBC8: 42 4B 50 54 20 45 52 52 
                FCB     'O,'R,'                  ; FBD0: 4F 52 20       
                FCB     $04                      ; FBD3: 04             
S1_TXT          FCB     $0d,$0a,$00              ; FBD4: 0D 0A 00       
                FCB     'S,'1                    ; FBD7: 53 31          
                FCB     $04                      ; FBD9: 04             
S9_TXT          FCB     $0d,$0a,$00              ; FBDA: 0D 0A 00       
                FCB     'S,'9,'0,'3,'0,'0,'0,'0  ; FBDD: 53 39 30 33 30 30 30 30 
                FCB     'F,'C                    ; FBE5: 46 43          
                FCB     $0d,$04                  ; FBE7: 0D 04          
S0_TXT          FCB     $0d,$0a,$00              ; FBE9: 0D 0A 00       
                FCB     'S,'0,'0,'B,'0,'0,'0,'0  ; FBEC: 53 30 30 42 30 30 30 30 
                FCB     '5,'8,'2,'0              ; FBF4: 35 38 32 30    
                FCB     $04                      ; FBF8: 04             
HD_TXT          FCB     'H,'D                    ; FBF9: 48 44          
RTNUSR          FCB     'R,'=,'X,'               ; FBFB: 52 3D 58 20    
                FCB     $04                      ; FBFF: 04             
