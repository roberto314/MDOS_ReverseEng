...
;****************************************************
                ...
                JMP     Z1831                    ; 129D: 7E 18 31       '~.1'
                JMP     Z184E                    ; 12A0: 7E 18 4E       '~.N'
                JMP     Z184E                    ; 12A3: 7E 18 4E       '~.N'
...
Z12B1           TSX                              ; 12B1: 30             '0'
                ...
                RTS                              ; 12B6: 39             '9'
Z12B7           JSR     Z0358                    ; 12B7: BD 03 58       '..X'
                TSX                              ; 12BA: 30             '0'
                CLR     $03,X                    ; 12BB: 6F 03          'o.'
                LDAB    #$08                     ; 12BD: C6 08          '..'
                JSR     Z1338                    ; 12BF: BD 13 38       '..8'
                TSTB                             ; 12C2: 5D             ']'
                BEQ     Z12D3                    ; 12C3: 27 0E          ''.'
                CMPB    #$08                     ; 12C5: C1 08          '..'
                BEQ     Z132D                    ; 12C7: 27 64          ''d'
...
Z12D3           CMPA    #$2E                     ; 12D3: 81 2E          '..'
                BNE     Z1327                    ; 12D5: 26 50          '&P'
                LDAB    #$82                     ; 12D7: C6 82          '..'
                JSR     Z1338                    ; 12D9: BD 13 38       '..8'
                TSTB                             ; 12DC: 5D             ']'
...
Z12E9           CMPA    #$3A                     ; 12E9: 81 3A          '.:'
                ...
                TBA                              ; 12F5: 17             '.'
                LDAB    #$C1                     ; 12F6: C6 C1          '..'
                JSR     Z1338                    ; 12F8: BD 13 38       '..8'
                JMP     Z1F65                    ; 12FB: 7E 1F 65       '~.e'
                LDX     $05,X                    ; 12FE: EE 05          '..'
                INX                              ; 1300: 08             '.'
                INX                              ; 1301: 08             '.'
                SWI                              ; 1302: 3F             '?'
...
Z1327           LDAB    #$02                     ; 1327: C6 02          '..'
                BSR     Z13A0                    ; 1329: 8D 75          '.u'
                BRA     Z12E9                    ; 132B: 20 BC          ' .'
Z132D           CMPA    #$23                     ; 132D: 81 23          '.#'
                BEQ     Z13AB                    ; 132F: 27 7A          ''z'
                LDAB    #$80                     ; 1331: C6 80          '..'
...
Z1355           ANDB    #$3F                     ; 1355: C4 3F          '.?'
                ...
                TSX                              ; 1362: 30             '0'
                INX                              ; 1363: 08             '.'
                JSR     Z0359                    ; 1364: BD 03 59       '..Y'
Z1367           BSR     Z130A                    ; 1367: 8D A1          '..'
                SWI                              ; 1369: 3F             '?'
                FCB     $15                      ; 136A: 15             '.'
                BCS     Z1351                    ; 136B: 25 E4          '%.'
Z136D           ORAA    #$30                     ; 136D: 8A 30          '.0'
...
Z13AB           LDAB    #$04                     ; 13AB: C6 04          '..'
                ...
                TBA                              ; 13B8: 17             '.'
                LDAB    #$88                     ; 13B9: C6 88          '..'
                JSR     Z1338                    ; 13BB: BD 13 38       '..8'
                JMP     Z1327                    ; 13BE: 7E 13 27       '~.''
Z13C1           PSHA                             ; 13C1: 36             '6'
                CMPB    #$01                     ; 13C2: C1 01          '..'
...
Z15C0           LDX     M1894                    ; 15C0: FE 18 94       '...'
                ...
                BCS     Z1646                    ; 15CC: 25 78          '%x'
                LDAB    ,X                       ; 15CE: E6 00          '..'
                LDX     M1894                    ; 15D0: FE 18 94       '...'
                INC     $03,X                    ; 15D3: 6C 03          'l.'
                BNE     Z15D9                    ; 15D5: 26 02          '&.'
                INC     $02,X                    ; 15D7: 6C 02          'l.'
...
Z1676           JMP     Z1754                    ; 1676: 7E 17 54       '~.T'
Z1679           JSR     Z169A                    ; 1679: BD 16 9A       '...'
                BCS     Z1676                    ; 167C: 25 F8          '%.'
Z167E           JMP     Z1769                    ; 167E: 7E 17 69       '~.i'
...
Z16E9           JMP     Z1766                    ; 16E9: 7E 17 66       '~.f'
Z16EC           CMPA    #$FF                     ; 16EC: 81 FF          '..'
                BCC     Z16E9                    ; 16EE: 24 F9          '$.'
Z16F0           INCA                             ; 16F0: 4C             'L'
                TAB                              ; 16F1: 16             '.'
...
Z170C           JSR     Z171C                    ; 170C: BD 17 1C       '...'
                BCS     Z1754                    ; 170F: 25 43          '%C'
                TST     M1896                    ; 1711: 7D 18 96       '}..'
                BPL     Z1719                    ; 1714: 2A 03          '*.'
                JMP     Z1672                    ; 1716: 7E 16 72       '~.r'
...
Z1778           LDX     M1894                    ; 1778: FE 18 94       '...'
                ...
                SEC                              ; 1780: 0D             '.'
Z1781           RTS                              ; 1781: 39             '9'
Z1782           DEC     M17FE                    ; 1782: 7A 17 FE       'z..'
                BNE     Z1797                    ; 1785: 26 10          '&.'
                TST     MFF02                    ; 1787: 7D FF 02       '}..'
                BPL     Z1797                    ; 178A: 2A 0B          '*.'
                LDAA    #$56                     ; 178C: 86 56          '.V'
                STAA    M17FE                    ; 178E: B7 17 FE       '...'
                BSR     Z17E0                    ; 1791: 8D 4D          '.M'
                LDAA    #$37                     ; 1793: 86 37          '.7'
                BSR     Z17E2                    ; 1795: 8D 4B          '.K'
